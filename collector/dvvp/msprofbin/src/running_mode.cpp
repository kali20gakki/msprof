    ...
    : RunningMode(preCheckParams, "app", params)
{
    whiteSet_ = {
        ...
        ARGS_PYTHON_PATH, ARGS_MSPROFTX, ARGS_PROFILING_DELAY, ARGS_PROFILING_DURATION, ARGS_TASK_MEMORY, ARGS_GE_API,
        ARGS_MSTX_DOMAIN_INCLUDE, ARGS_MSTX_DOMAIN_EXCLUDE
    };
}
