...
typedef enum {
    ...
    ACL_PROF_SYS_IO_FREQ = 24,
    ACL_PROF_SYS_INTERCONNECTION_FREQ = 25,
    ACL_PROF_DVPP_FREQ = 26,
    ACL_PROF_HOST_SYS_USAGE_FREQ = 27,
    ACL_PROF_L2_SAMPLE_FREQ = 28,
    ACL_PROF_LLC_MODE = 30,
    // host-sys 40-
