...
static const uint64_t PROF_SWITCH_SUPPORT = PROF_ACL_API | PROF_TASK_TIME | PROF_AICORE_METRICS | PROF_AICPU_TRACE |
    ...
    PROF_AIV_METRICS | PROF_SUBTASK_TIME | PROF_KEYPOINT_TRACE | PROF_HCCL_TRACE |
...
#else
static const uint64_t PROF_SWITCH_SUPPORT = PROF_ACL_API | PROF_TASK_TIME | PROF_AICORE_METRICS | PROF_AICPU_TRACE |
    PROF_L2CACHE | PROF_HCCL_TRACE | PROF_KEYPOINT_TRACE | PROF_MSPROFTX | PROF_RUNTIME_API | PROF_AICPU_MODEL;
#endif // MSPROF_DEBUG
