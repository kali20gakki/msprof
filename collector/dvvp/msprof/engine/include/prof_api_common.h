...
static const uint64_t PROF_SWITCH_SUPPORT = PROF_ACL_API | PROF_TASK_TIME_L0 | PROF_AICORE_METRICS | PROF_AICPU_TRACE |
    PROF_L2CACHE | PROF_HCCL_TRACE | PROF_KEYPOINT_TRACE | PROF_MSPROFTX | PROF_RUNTIME_API | PROF_TASK_MEMORY |
    PROF_TASK_TIME_L1 | PROF_TASK_TIME_L2 | PROF_OP_ATTR;
