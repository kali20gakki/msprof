...
#ifdef MSPROF_DEBUG
static const uint64_t PROF_SWITCH_SUPPORT = PROF_ACL_API | PROF_TASK_TIME | PROF_AICORE_METRICS | PROF_AICPU |
    PROF_MODEL_EXECUTE | PROF_RUNTIME_API | PROF_RUNTIME_TRACE | PROF_SCHEDULE_TIMELINE | PROF_SCHEDULE_TRACE |
    PROF_AIV_METRICS | PROF_SUBTASK_TIME | PROF_TRAINING_TRACE | PROF_HCCL_TRACE |
    PROF_SYS_CPU | PROF_SYS_HARDWARE_MEM | PROF_SYS_IO | PROF_SYS_INTERCONNECTION | PROF_DVPP | PROF_SYS_AICORE_SAMPLE |
    PROF_AIVECTORCORE_SAMPLE | PROF_L2CACHE | PROF_MSPROFTX | PROF_AICPU_MODEL;
#else
static const uint64_t PROF_SWITCH_SUPPORT = PROF_ACL_API | PROF_TASK_TIME | PROF_AICORE_METRICS | PROF_AICPU |
    PROF_L2CACHE | PROF_HCCL_TRACE | PROF_TRAINING_TRACE | PROF_MSPROFTX | PROF_RUNTIME_API | PROF_AICPU_MODEL;
#endif // MSPROF_DEBUG
