...
enum ProfCollectionJobE {
    ...
    // host system
    HOST_PID_CPU_COLLECTION_JOB,
    HOST_PID_MEM_COLLECTION_JOB,
    HOST_ALL_PID_CPU_COLLECTION_JOB,
    HOST_ALL_PID_MEM_COLLECTION_JOB,
    HOST_SYS_CPU_COLLECTION_JOB,
    HOST_SYS_MEM_COLLECTION_JOB,
