...
PlatformAdapterMini::PlatformAdapterMini() : platformType_(PlatformType::END_TYPE)
{
}
...
int PlatformAdapterMini::Init()
{
    ...
    getLlcEvents_ = {{"capacity", GenerateCapacityEvents},
                     {"bandwidth", GenerateBandwidthEvents}};
    aicRunningFreq_ = "680";
    sysCountFreq_ = "19.2";
