    ...
    PlatformType platformType)
{
    ...
    supportSwitch_ = {
        ...
        PLATFORM_TASK_TS_KEYPOINT_TRAINING, PLATFORM_TASK_TS_MEMCPY, PLATFORM_TASK_AIC_HWTS, PLATFORM_TASK_AIV_HWTS,
        PLATFORM_TASK_AIC_METRICS, PLATFORM_TASK_AIV_METRICS, PLATFORM_TASK_MEMORY,
        ...
        PLATFORM_SYS_DEVICE_HBM, PLATFORM_SYS_DEVICE_DVPP, PLATFORM_TASK_OP_ATTR};
    aicRunningFreq_ = "960";
    sysCountFreq_ = "38.4";
