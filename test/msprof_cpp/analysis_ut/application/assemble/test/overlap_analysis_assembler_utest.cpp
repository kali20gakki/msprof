...
****************************************************************************** */
/* ******************************************************************************
 * File Name          : overlap_analysis_assembler_utest.cpp
 * Description        : overlap_analysis_assembler UT
 * Author             : MSPROF TEAM
 * Creation Date      : 2024/08/2024/8/31
 * *****************************************************************************
 */
...
const std::string SCENARIOS1_JSON =
    ...
    "{\"name\":\"thread_name\",\"pid\":10330016,\"tid\":1,\"ph\":\"M\","
    ...
    "{\"name\":\"Computing\",\"pid\":10330016,\"tid\":2,\"ts\":\"0.001000\","
    "\"dur\":0.002,\"ph\":\"X\",\"args\":{}},"
    "{\"name\":\"Computing\",\"pid\":10330016,\"tid\":2,\"ts\":\"0.006000\","
    "\"dur\":0.003,\"ph\":\"X\",\"args\":{}},"
    "{\"name\":\"Computing\",\"pid\":10330016,\"tid\":2,\"ts\":\"0.015000\","
    "\"dur\":0.009,\"ph\":\"X\",\"args\":{}},"
    "{\"name\":\"Computing\",\"pid\":10330016,\"tid\":2,\"ts\":\"0.026000\","
    "\"dur\":0.007,\"ph\":\"X\",\"args\":{}},"
    "{\"name\":\"Computing\",\"pid\":10330016,\"tid\":2,\"ts\":\"0.034000\","
    "\"dur\":0.002,\"ph\":\"X\",\"args\":{}},"
    "{\"name\":\"Communication\",\"pid\":10330016,\"tid\":0,\"ts\":\"0.004000\","
    "\"dur\":0.009,\"ph\":\"X\",\"args\":{}},"
    "{\"name\":\"Communication\",\"pid\":10330016,\"tid\":0,\"ts\":\"0.014000\","
    "\"dur\":0.003,\"ph\":\"X\",\"args\":{}},"
    "{\"name\":\"Communication\",\"pid\":10330016,\"tid\":0,\"ts\":\"0.020000\","
    "\"dur\":0.004,\"ph\":\"X\",\"args\":{}},"
    "{\"name\":\"Communication\",\"pid\":10330016,\"tid\":0,\"ts\":\"0.025000\","
    "\"dur\":0.016,\"ph\":\"X\",\"args\":{}},"
    "{\"name\":\"Communication(Not Overlapped)\",\"pid\":10330016,\"tid\":1,\"ts\":\"0.004000\","
    "\"dur\":0.002,\"ph\":\"X\",\"args\":{}},"
    "{\"name\":\"Communication(Not Overlapped)\",\"pid\":10330016,\"tid\":1,\"ts\":\"0.009000\","
    "\"dur\":0.004,\"ph\":\"X\",\"args\":{}},"
    "{\"name\":\"Communication(Not Overlapped)\",\"pid\":10330016,\"tid\":1,\"ts\":\"0.014000\","
    "\"dur\":0.001,\"ph\":\"X\",\"args\":{}},"
    "{\"name\":\"Communication(Not Overlapped)\",\"pid\":10330016,\"tid\":1,\"ts\":\"0.025000\","
    "\"dur\":0.001,\"ph\":\"X\",\"args\":{}},"
    "{\"name\":\"Communication(Not Overlapped)\",\"pid\":10330016,\"tid\":1,\"ts\":\"0.033000\","
    "\"dur\":0.001,\"ph\":\"X\",\"args\":{}},"
    "{\"name\":\"Communication(Not Overlapped)\",\"pid\":10330016,\"tid\":1,\"ts\":\"0.036000\","
    "\"dur\":0.005,\"ph\":\"X\",\"args\":{}},"
    "{\"name\":\"Free\",\"pid\":10330016,\"tid\":3,\"ts\":\"0.003000\","
    "\"dur\":0.001,\"ph\":\"X\",\"args\":{}},"
    "{\"name\":\"Free\",\"pid\":10330016,\"tid\":3,\"ts\":\"0.013000\","
    "\"dur\":0.001,\"ph\":\"X\",\"args\":{}},"
    "{\"name\":\"Free\",\"pid\":10330016,\"tid\":3,\"ts\":\"0.024000\","
    "\"dur\":0.001,\"ph\":\"X\",\"args\":{}},"
    ...
    "{\"name\":\"thread_name\",\"pid\":10330017,\"tid\":1,\"ph\":\"M\","
    "\"args\":{\"name\":\"Communication(Not Overlapped)\"}},"
    "{\"name\":\"thread_sort_index\",\"pid\":10330017,\"tid\":1,\"ph\":\"M\",\"args\":{\"sort_index\":1}},"
    "{\"name\":\"thread_name\",\"pid\":10330017,\"tid\":2,\"ph\":\"M\",\"args\":{\"name\":\"Computing\"}},"
    "{\"name\":\"thread_sort_index\",\"pid\":10330017,\"tid\":2,\"ph\":\"M\",\"args\":{\"sort_index\":2}},"
    "{\"name\":\"thread_name\",\"pid\":10330017,\"tid\":3,\"ph\":\"M\",\"args\":{\"name\":\"Free\"}},"
    "{\"name\":\"thread_sort_index\",\"pid\":10330017,\"tid\":3,\"ph\":\"M\",\"args\":{\"sort_index\":3}},"
    "{\"name\":\"Computing\",\"pid\":10330017,\"tid\":2,\"ts\":\"0.001000\","
    "\"dur\":0.002,\"ph\":\"X\",\"args\":{}},"
    "{\"name\":\"Computing\",\"pid\":10330017,\"tid\":2,\"ts\":\"0.006000\","
    "\"dur\":0.003,\"ph\":\"X\",\"args\":{}},"
    "{\"name\":\"Computing\",\"pid\":10330017,\"tid\":2,\"ts\":\"0.015000\","
    "\"dur\":0.009,\"ph\":\"X\",\"args\":{}},"
    "{\"name\":\"Computing\",\"pid\":10330017,\"tid\":2,\"ts\":\"0.026000\","
    "\"dur\":0.007,\"ph\":\"X\",\"args\":{}},"
    "{\"name\":\"Computing\",\"pid\":10330017,\"tid\":2,\"ts\":\"0.034000\","
    "\"dur\":0.002,\"ph\":\"X\",\"args\":{}},"
    "{\"name\":\"Communication\",\"pid\":10330017,\"tid\":0,\"ts\":\"0.004000\","
    "\"dur\":0.009,\"ph\":\"X\",\"args\":{}},"
    "{\"name\":\"Communication\",\"pid\":10330017,\"tid\":0,\"ts\":\"0.014000\","
    "\"dur\":0.003,\"ph\":\"X\",\"args\":{}},"
    "{\"name\":\"Communication\",\"pid\":10330017,\"tid\":0,\"ts\":\"0.020000\","
    "\"dur\":0.004,\"ph\":\"X\",\"args\":{}},"
    "{\"name\":\"Communication\",\"pid\":10330017,\"tid\":0,\"ts\":\"0.025000\","
    "\"dur\":0.016,\"ph\":\"X\",\"args\":{}},"
    "{\"name\":\"Communication(Not Overlapped)\",\"pid\":10330017,\"tid\":1,\"ts\":\"0.004000\","
    "\"dur\":0.002,\"ph\":\"X\",\"args\":{}},"
    "{\"name\":\"Communication(Not Overlapped)\",\"pid\":10330017,\"tid\":1,\"ts\":\"0.009000\","
    "\"dur\":0.004,\"ph\":\"X\",\"args\":{}},"
    "{\"name\":\"Communication(Not Overlapped)\",\"pid\":10330017,\"tid\":1,\"ts\":\"0.014000\","
    "\"dur\":0.001,\"ph\":\"X\",\"args\":{}},"
    "{\"name\":\"Communication(Not Overlapped)\",\"pid\":10330017,\"tid\":1,\"ts\":\"0.025000\","
    "\"dur\":0.001,\"ph\":\"X\",\"args\":{}},"
    "{\"name\":\"Communication(Not Overlapped)\",\"pid\":10330017,\"tid\":1,\"ts\":\"0.033000\","
    "\"dur\":0.001,\"ph\":\"X\",\"args\":{}},"
    "{\"name\":\"Communication(Not Overlapped)\",\"pid\":10330017,\"tid\":1,\"ts\":\"0.036000\","
    "\"dur\":0.005,\"ph\":\"X\",\"args\":{}},"
    "{\"name\":\"Free\",\"pid\":10330017,\"tid\":3,\"ts\":\"0.003000\",\"dur\":0.001,\"ph\":\"X\",\"args\":{}},"
    "{\"name\":\"Free\",\"pid\":10330017,\"tid\":3,\"ts\":\"0.013000\",\"dur\":0.001,\"ph\":\"X\",\"args\":{}},"
    "{\"name\":\"Free\",\"pid\":10330017,\"tid\":3,\"ts\":\"0.024000\",\"dur\":0.001,\"ph\":\"X\",\"args\":{}},";
const std::string SCENARIOS2_JSON =
    ...
    "{\"name\":\"thread_name\",\"pid\":10330016,\"tid\":3,\"ph\":\"M\",\"args\":{\"name\":\"Free\"}},"
    "{\"name\":\"thread_sort_index\",\"pid\":10330016,\"tid\":3,\"ph\":\"M\",\"args\":{\"sort_index\":3}},"
    "{\"name\":\"Computing\",\"pid\":10330016,\"tid\":2,\"ts\":\"0.001000\",\"dur\":0.002,\"ph\":\"X\",\"args\":{}},"
    "{\"name\":\"Computing\",\"pid\":10330016,\"tid\":2,\"ts\":\"0.006000\",\"dur\":0.003,\"ph\":\"X\",\"args\":{}},"
    "{\"name\":\"Computing\",\"pid\":10330016,\"tid\":2,\"ts\":\"0.015000\",\"dur\":0.009,\"ph\":\"X\",\"args\":{}},"
    "{\"name\":\"Computing\",\"pid\":10330016,\"tid\":2,\"ts\":\"0.026000\",\"dur\":0.007,\"ph\":\"X\",\"args\":{}},"
    "{\"name\":\"Computing\",\"pid\":10330016,\"tid\":2,\"ts\":\"0.034000\",\"dur\":0.002,\"ph\":\"X\",\"args\":{}},"
    "{\"name\":\"Communication\",\"pid\":10330016,\"tid\":0,\"ts\":\"0.004000\","
    "\"dur\":0.004,\"ph\":\"X\",\"args\":{}},"
    "{\"name\":\"Communication\",\"pid\":10330016,\"tid\":0,\"ts\":\"0.009000\","
    "\"dur\":0.004,\"ph\":\"X\",\"args\":{}},"
    "{\"name\":\"Communication\",\"pid\":10330016,\"tid\":0,\"ts\":\"0.014000\","
    "\"dur\":0.003,\"ph\":\"X\",\"args\":{}},"
    "{\"name\":\"Communication\",\"pid\":10330016,\"tid\":0,\"ts\":\"0.020000\","
    ...
    "{\"name\":\"Communication(Not Overlapped)\",\"pid\":10330016,\"tid\":1,\"ts\":\"0.036000\","
    "\"dur\":0.005,\"ph\":\"X\",\"args\":{}},"
    "{\"name\":\"Free\",\"pid\":10330016,\"tid\":3,\"ts\":\"0.003000\",\"dur\":0.001,\"ph\":\"X\",\"args\":{}},"
    "{\"name\":\"Free\",\"pid\":10330016,\"tid\":3,\"ts\":\"0.013000\",\"dur\":0.001,\"ph\":\"X\",\"args\":{}},"
    "{\"name\":\"Free\",\"pid\":10330016,\"tid\":3,\"ts\":\"0.024000\",\"dur\":0.001,\"ph\":\"X\",\"args\":{}},";
const std::string SCENARIOS3_JSON =
    ...
    "{\"name\":\"Computing\",\"pid\":10330016,\"tid\":2,\"ts\":\"0.026000\",\"dur\":0.007,\"ph\":\"X\",\"args\":{}},"
    "{\"name\":\"Computing\",\"pid\":10330016,\"tid\":2,\"ts\":\"0.034000\",\"dur\":0.002,\"ph\":\"X\",\"args\":{}},"
    "{\"name\":\"Free\",\"pid\":10330016,\"tid\":3,\"ts\":\"0.003000\",\"dur\":0.003,\"ph\":\"X\",\"args\":{}},"
    "{\"name\":\"Free\",\"pid\":10330016,\"tid\":3,\"ts\":\"0.009000\",\"dur\":0.006,\"ph\":\"X\",\"args\":{}},"
    "{\"name\":\"Free\",\"pid\":10330016,\"tid\":3,\"ts\":\"0.024000\",\"dur\":0.002,\"ph\":\"X\",\"args\":{}},"
    "{\"name\":\"Free\",\"pid\":10330016,\"tid\":3,\"ts\":\"0.033000\",\"dur\":0.001,\"ph\":\"X\",\"args\":{}},";
const std::string SCENARIOS4_JSON =
    ...
    "{\"name\":\"Communication(Not Overlapped)\",\"pid\":10330016,\"tid\":1,\"ts\":\"0.014000\","
    "\"dur\":0.003,\"ph\":\"X\",\"args\":{}},"
    "{\"name\":\"Communication(Not Overlapped)\",\"pid\":10330016,\"tid\":1,\"ts\":\"0.020000\","
    "\"dur\":0.004,\"ph\":\"X\",\"args\":{}},"
    "{\"name\":\"Communication(Not Overlapped)\",\"pid\":10330016,\"tid\":1,\"ts\":\"0.025000\","
    "\"dur\":0.016,\"ph\":\"X\",\"args\":{}},"
    "{\"name\":\"Free\",\"pid\":10330016,\"tid\":3,\"ts\":\"0.008000\",\"dur\":0.001,\"ph\":\"X\",\"args\":{}},"
    "{\"name\":\"Free\",\"pid\":10330016,\"tid\":3,\"ts\":\"0.013000\",\"dur\":0.001,\"ph\":\"X\",\"args\":{}},"
    "{\"name\":\"Free\",\"pid\":10330016,\"tid\":3,\"ts\":\"0.017000\",\"dur\":0.003,\"ph\":\"X\",\"args\":{}},"
    "{\"name\":\"Free\",\"pid\":10330016,\"tid\":3,\"ts\":\"0.024000\",\"dur\":0.001,\"ph\":\"X\",\"args\":{}},"
    "{\"name\":\"process_name\",\"pid\":10354687,\"tid\":0,\"ph\":\"M\",\"args\":{\"name\":\"Overlap Analysis\"}},"
    "{\"name\":\"process_labels\",\"pid\":10354687,\"tid\":0,\"ph\":\"M\",\"args\":{\"labels\":\"NPU\"}},"
    "{\"name\":\"process_sort_index\",\"pid\":10354687,\"tid\":0,\"ph\":\"M\",\"args\":{\"sort_index\":29}},"
