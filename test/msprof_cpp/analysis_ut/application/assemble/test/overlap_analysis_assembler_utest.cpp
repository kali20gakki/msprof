...
const std::string SCENARIOS1_JSON =
    "{\"name\":\"process_name\",\"pid\":10329985,\"tid\":0,\"ph\":\"M\",\"args\":{\"name\":\"Overlap Analysis\"}},"
    "{\"name\":\"process_labels\",\"pid\":10329985,\"tid\":0,\"ph\":\"M\",\"args\":{\"labels\":\"NPU\"}},"
    "{\"name\":\"process_sort_index\",\"pid\":10329985,\"tid\":0,\"ph\":\"M\",\"args\":{\"sort_index\":28}},"
    ...
    "{\"name\":\"Computing\",\"pid\":10329984,\"tid\":2,\"ts\":\"0.001000\","
    "\"dur\":0.002,\"ph\":\"X\",\"args\":{}},"
    "{\"name\":\"Computing\",\"pid\":10329984,\"tid\":2,\"ts\":\"0.006000\","
    "\"dur\":0.003,\"ph\":\"X\",\"args\":{}},"
    "{\"name\":\"Computing\",\"pid\":10329984,\"tid\":2,\"ts\":\"0.015000\","
    "\"dur\":0.009,\"ph\":\"X\",\"args\":{}},"
    "{\"name\":\"Computing\",\"pid\":10329984,\"tid\":2,\"ts\":\"0.026000\","
    "\"dur\":0.007,\"ph\":\"X\",\"args\":{}},"
    "{\"name\":\"Computing\",\"pid\":10329984,\"tid\":2,\"ts\":\"0.034000\","
    "\"dur\":0.002,\"ph\":\"X\",\"args\":{}},"
    ...
    "\"dur\":0.005,\"ph\":\"X\",\"args\":{}},"
    "{\"name\":\"Free\",\"pid\":10329984,\"tid\":3,\"ts\":\"0.003000\","
    "\"dur\":0.001,\"ph\":\"X\",\"args\":{}},"
    "{\"name\":\"Free\",\"pid\":10329984,\"tid\":3,\"ts\":\"0.013000\","
    "\"dur\":0.001,\"ph\":\"X\",\"args\":{}},"
    "{\"name\":\"Free\",\"pid\":10329984,\"tid\":3,\"ts\":\"0.024000\","
    "\"dur\":0.001,\"ph\":\"X\",\"args\":{}},"
    "{\"name\":\"process_name\",\"pid\":10329985,\"tid\":0,\"ph\":\"M\","
    "\"args\":{\"name\":\"Overlap Analysis\"}},"
    "{\"name\":\"process_labels\",\"pid\":10329985,\"tid\":0,\"ph\":\"M\","
    "\"args\":{\"labels\":\"NPU\"}},"
    "{\"name\":\"process_sort_index\",\"pid\":10329985,\"tid\":0,\"ph\":\"M\",\"args\":{\"sort_index\":28}},"
    "{\"name\":\"process_name\",\"pid\":10329984,\"tid\":0,\"ph\":\"M\",\"args\":{\"name\":\"Overlap Analysis\"}},"
    "{\"name\":\"process_labels\",\"pid\":10329984,\"tid\":0,\"ph\":\"M\",\"args\":{\"labels\":\"NPU\"}},"
    "{\"name\":\"process_sort_index\",\"pid\":10329984,\"tid\":0,\"ph\":\"M\",\"args\":{\"sort_index\":28}},"
    "{\"name\":\"thread_name\",\"pid\":10329985,\"tid\":0,\"ph\":\"M\",\"args\":{\"name\":\"Communication\"}},"
    "{\"name\":\"thread_sort_index\",\"pid\":10329985,\"tid\":0,\"ph\":\"M\",\"args\":{\"sort_index\":0}},"
    "{\"name\":\"thread_name\",\"pid\":10329985,\"tid\":1,\"ph\":\"M\","
    "\"args\":{\"name\":\"Communication(Not Overlapped)\"}},"
    "{\"name\":\"thread_sort_index\",\"pid\":10329985,\"tid\":1,\"ph\":\"M\",\"args\":{\"sort_index\":1}},"
    "{\"name\":\"thread_name\",\"pid\":10329985,\"tid\":2,\"ph\":\"M\",\"args\":{\"name\":\"Computing\"}},"
    "{\"name\":\"thread_sort_index\",\"pid\":10329985,\"tid\":2,\"ph\":\"M\",\"args\":{\"sort_index\":2}},"
    "{\"name\":\"thread_name\",\"pid\":10329985,\"tid\":3,\"ph\":\"M\",\"args\":{\"name\":\"Free\"}},"
    "{\"name\":\"thread_sort_index\",\"pid\":10329985,\"tid\":3,\"ph\":\"M\",\"args\":{\"sort_index\":3}},"
    "{\"name\":\"Computing\",\"pid\":10329985,\"tid\":2,\"ts\":\"0.001000\","
    "\"dur\":0.002,\"ph\":\"X\",\"args\":{}},"
    "{\"name\":\"Computing\",\"pid\":10329985,\"tid\":2,\"ts\":\"0.006000\","
    "\"dur\":0.003,\"ph\":\"X\",\"args\":{}},"
    "{\"name\":\"Computing\",\"pid\":10329985,\"tid\":2,\"ts\":\"0.015000\","
    "\"dur\":0.009,\"ph\":\"X\",\"args\":{}},"
    "{\"name\":\"Computing\",\"pid\":10329985,\"tid\":2,\"ts\":\"0.026000\","
    "\"dur\":0.007,\"ph\":\"X\",\"args\":{}},"
    "{\"name\":\"Computing\",\"pid\":10329985,\"tid\":2,\"ts\":\"0.034000\","
    "\"dur\":0.002,\"ph\":\"X\",\"args\":{}},"
    "{\"name\":\"Communication\",\"pid\":10329985,\"tid\":0,\"ts\":\"0.004000\","
    "\"dur\":0.009,\"ph\":\"X\",\"args\":{}},"
    "{\"name\":\"Communication\",\"pid\":10329985,\"tid\":0,\"ts\":\"0.014000\","
    "\"dur\":0.003,\"ph\":\"X\",\"args\":{}},"
    "{\"name\":\"Communication\",\"pid\":10329985,\"tid\":0,\"ts\":\"0.020000\","
    "\"dur\":0.004,\"ph\":\"X\",\"args\":{}},"
    "{\"name\":\"Communication\",\"pid\":10329985,\"tid\":0,\"ts\":\"0.025000\","
    "\"dur\":0.016,\"ph\":\"X\",\"args\":{}},"
    "{\"name\":\"Communication(Not Overlapped)\",\"pid\":10329985,\"tid\":1,\"ts\":\"0.004000\","
    "\"dur\":0.002,\"ph\":\"X\",\"args\":{}},"
    "{\"name\":\"Communication(Not Overlapped)\",\"pid\":10329985,\"tid\":1,\"ts\":\"0.009000\","
    "\"dur\":0.004,\"ph\":\"X\",\"args\":{}},"
    "{\"name\":\"Communication(Not Overlapped)\",\"pid\":10329985,\"tid\":1,\"ts\":\"0.014000\","
    "\"dur\":0.001,\"ph\":\"X\",\"args\":{}},"
    "{\"name\":\"Communication(Not Overlapped)\",\"pid\":10329985,\"tid\":1,\"ts\":\"0.025000\","
    "\"dur\":0.001,\"ph\":\"X\",\"args\":{}},"
    "{\"name\":\"Communication(Not Overlapped)\",\"pid\":10329985,\"tid\":1,\"ts\":\"0.033000\","
    "\"dur\":0.001,\"ph\":\"X\",\"args\":{}},"
    "{\"name\":\"Communication(Not Overlapped)\",\"pid\":10329985,\"tid\":1,\"ts\":\"0.036000\","
    "\"dur\":0.005,\"ph\":\"X\",\"args\":{}},"
