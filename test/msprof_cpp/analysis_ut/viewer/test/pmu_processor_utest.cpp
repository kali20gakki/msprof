...
using OTFormat = std::vector<std::tuple<double, double, double, double, double, double, double, double,
...
protected:
    static void SetUpTestCase()
    {
        ...
        Analysis::Log::GetInstance().Init(PMU_DIR);
