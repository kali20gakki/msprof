...
class TestFftsPlusPmuBean(unittest.TestCase):
    def test_instance_of_ffts_plus_pmu_bean(self):
        args = (40, 1, 2, 3, 21474836484, 6, 7, 2312, 513, 17179869187, 5, 6, 8, 9, 4, 5, 8, 9, 7, 5, 7, 8)
        ffts_plus_pmu_bean = FftsPlusPmuBean(args)
        self.assertEqual([2, 3, 7, 0, 6, 5, (8, 9, 4, 5, 8, 9, 7, 5), (7, 8)], [ffts_plus_pmu_bean.stream_id,
    ...
    def test_instance_of_ffts_plus_pmu_bean_is_no_aic_data(self):
        args = (40, 1, 2, 3, 21474836484, 6, 7, 23111, 513, 17179869187, 5, 6, 8, 9, 4, 5, 8, 9, 7, 5, 7, 8)
        ffts_plus_pmu_bean = FftsPlusPmuBean(args)
        self.assertEqual([2, 3, 7, 2, 6, 5, (8, 9, 4, 5, 8, 9, 7, 5), (7, 8)], [ffts_plus_pmu_bean.stream_id,
                                                                                ffts_plus_pmu_bean.task_id,
                                                                                ffts_plus_pmu_bean.subtask_id,
                                                                                ffts_plus_pmu_bean.ffts_type,
                                                                                ffts_plus_pmu_bean.subtask_type,
