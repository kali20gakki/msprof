...
class TestMsProfExportDataUtils(unittest.TestCase):
    ...
    def test_export_summary_data_1(self):
        ...
        with mock.patch(NAMESPACE + '.MsProfExportDataUtils._make_export_file_name', return_value=2), \
    ...
    def test_export_summary_data_2(self):
        ...
        with mock.patch(NAMESPACE + '.MsProfExportDataUtils._make_export_file_name', return_value=1), \
             mock.patch(NAMESPACE + '.check_file_writable'), \
