...
// TEST_F(MSPROF_ACL_CORE_UTEST, ge_option) { XXX
//     GlobalMockObject::verify();
...
//     message->set_stars_acsq_task("on");
//     message->set_stars_sub_task("on");
//     message->set_ffts_thread_task("on");
//     message->set_ffts_block("on");
//     message->set_low_power("on");
//     message->set_acc_pmu_mode("task-based");
...
// TEST_F(MSPROF_ACL_CORE_UTEST, init_env) { XXX
//     GlobalMockObject::verify();
...
// TEST_F(MSPROF_ACL_CORE_UTEST, MsprofInitHelper) { XXX
//     GlobalMockObject::verify();
