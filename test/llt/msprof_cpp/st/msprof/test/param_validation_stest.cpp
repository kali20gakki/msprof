...
TEST_F(COMMON_VALIDATION_PARAM_VALIDATION_STEST, CheckNameContainsDangerCharacter) {
    auto entry = analysis::dvvp::common::validation::ParamValidation::instance();
...
TEST_F(COMMON_VALIDATION_PARAM_VALIDATION_STEST, CheckProfilingAicoreMetricsIsValid) {
    GlobalMockObject::verify();
...
TEST_F(COMMON_VALIDATION_PARAM_VALIDATION_STEST, CheckL2CacheEventsValid) {
    GlobalMockObject::verify();
