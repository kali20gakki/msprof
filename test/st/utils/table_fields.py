...
class TableFields:
    ...
    COMMUNICATION_TASK_INFO = [
        "name", "globalTaskId", "taskType", "planeId", "groupName", "notifyId", "rdmaType", "srcRank", "dstRank",
        "transportType",
    ...
    NETDEV_STATS = [
        "deviceId", "timestampNs", "macTxPfcPkt", "macRxPfcPkt", "macTxByte", "macTxBandwidth", "macRxByte",
        "macRxBandwidth",
        "macTxBadByte", "macRxBadByte", "roceTxPkt", "roceRxPkt", "roceTxErrPkt", "roceRxErrPkt", "roceTxCnpPkt",
        "roceRxCnpPkt",
        "roceNewPktRty", "nicTxByte", "nicTxBandwidth", "nicRxByte", "nicRxBandwidth"
    ]
    NIC = [
        "deviceId", "timestampNs", "bandwidth", "rxPacketRate", "rxByteRate", "rxPackets", "rxBytes", "rxErrors",
        "rxDropped",
    ...
    NPU_OP_MEM = [
        "operatorName", "addr", "type", "size", "timestampNs", "globalTid", "totalAllocate", "totalReserve",
        "component",
        "deviceId"
    ]
    OP_MEMORY = [
        "name", "size", "allocationTime", "releaseTime", "activeReleaseTime", "duration", "activeDuration",
    ...
    PCIE = [
        "deviceId", "timestampNs", "txPostMin", "txPostMax", "txPostAvg", "txNonpostMin", "txNonpostMax",
        "txNonpostAvg", "txCplMin",
        "txCplMax", "txCplAvg", "txNonpostLatencyMin", "txNonpostLatencyMax", "txNonpostLatencyAvg", "rxPostMin",
        "rxPostMax",
        "rxPostAvg", "rxNonpostMin", "rxNonpostMax", "rxNonpostAvg", "rxCplMin", "rxCplMax", "rxCplAvg"
    ]
    PYTORCH_API = [
        "startNs", "endNs", "globalTid", "connectionId", "name", "sequenceNumber", "fwdThreadId", "inputDtypes",
        "inputShapes",
        "callchainId", "type"
    ]
    PYTORCH_CALLCHAINS = [
    ...
    ClusterCommunicationBandwidth = ["step", "rank_id", "hccl_op_name", "group_name", "band_type", "transit_size",
                                     "transit_time", "bandwidth", "large_packet_ratio", "package_size", "count",
                                     "total_duration"]
    ClusterCommunicationMatrix = ["step", "hccl_op_name", "group_name", "src_rank", "dst_rank", "transport_type",
                                  "op_name",
                                  "transit_size", "transit_time", "bandwidth"]
    ClusterCommunicationTime = ["step", "rank_id", "hccl_op_name", "group_name", "start_timestamp", "elapsed_time",
                                "transit_time",
                                "wait_time", "synchronization_time", "idle_time", "synchronization_time_ratio",
                                "wait_time_ratio"]
    ClusterStepTraceTime = ["step", "type", "index", "computing", "communication_not_overlapped", "overlapped",
                            "communication",
