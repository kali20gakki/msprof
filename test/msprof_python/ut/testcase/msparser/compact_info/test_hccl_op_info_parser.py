...
class TestHcclOpInfoParser(unittest.TestCase):
    ...
    def test_reformat_data(self):
        ...
        with mock.patch(GE_HASH_MODEL_NAMESPACE + '.GeHashViewModel.init'), \
            ...
            self.assertEqual(data[0][4:], [0, 1, 'FP16', 'NHR-HD', 43642, '72840854065026987'])
            self.assertEqual(data[1][4:], [0, 0, 'FP32', 'MESH-NB', 74162, '16426617625805244'])
            self.assertEqual(data[2][4:], [1, 0, 'INT32', 'NONE', 61555, '9380863679156556794'])
