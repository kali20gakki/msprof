...
class TestMemoryCopyViewer(unittest.TestCase):
    ...
    def test_get_memory_copy_chip0_summary_1(self):
        expect_res = [(0, 20000, 1, 20000.0, 20000, 20000, 100, 20000, MemoryCopyConstant.DEFAULT_VIEWER_VALUE,
        ...
        export_data = [(20000, MemoryCopyConstant.TYPE,
                       1, 1, 100, 20000)]
        with mock.patch(NAMESPACE + '.check_db', return_value=True), \
                mock.patch(NAMESPACE + '.export_chip0_summary', return_value=export_data):
    ...
    def test_get_memory_copy_non_chip0_summary_1(self):
        ...
        export_data = [(MemoryCopyConstant.ASYNC_MEMCPY_NAME, MemoryCopyConstant.TYPE, 11,
                       12, 100, 2.2, 2.3)]
        with mock.patch(NAMESPACE + '.check_db', return_value=True), \
                mock.patch(NAMESPACE + '.export_non_chip0_summary', return_value=export_data):
