...
Status RunContextUtil::CreateRtModelResources(uint32_t stream_num, uint32_t event_num, uint32_t label_num) {
  ...
  if (rt_ret != RT_ERROR_NONE) {
    REPORT_CALL_ERROR("E19999", "call rtModelCreate failed, ret:%d,", static_cast<int32_t>(rt_ret));
    GELOGE(RT_FAILED, "[Call][RtModelCreate] failed. rt_ret = %d", static_cast<int32_t>(rt_ret));
    return RT_FAILED;
  }
  ...
  for (uint32_t i = 0; i < stream_num; ++i) {
    ...
    if (rt_ret != RT_ERROR_NONE) {
      REPORT_CALL_ERROR("E19999", "call rtStreamCreate failed, ret:%d, index:%u,",
                        static_cast<int32_t>(rt_ret), i);
      GELOGE(RT_FAILED, "[Call][RtStreamCreate] failed. rt_ret = %d, index = %u", static_cast<int32_t>(rt_ret), i);
      return RT_FAILED;
    }
    ...
    if (rt_ret != RT_ERROR_NONE) {
      REPORT_CALL_ERROR("E19999", "call rtModelBindStream failed, ret:%d, index:%u,",
                        static_cast<int32_t>(rt_ret), i);
      GELOGE(RT_FAILED, "[Bind][StreamAndModel] failed. rt_ret = %d, index = %u", static_cast<int32_t>(rt_ret), i);
      return RT_FAILED;
    }
  }
  ...
  for (uint32_t i = 0; i < event_num; ++i) {
    ...
    if (rt_ret != RT_ERROR_NONE) {
      REPORT_CALL_ERROR("E19999", "call rtEventCreate failed, ret:%d, index:%u,",
                        static_cast<int32_t>(rt_ret), i);
      GELOGE(RT_FAILED, "[Call][RtEventCreate] failed. rt_ret = %d, index = %u", static_cast<int32_t>(rt_ret), i);
      return RT_FAILED;
    }
  ...
  for (uint32_t i = 0; i < label_num; ++i) {
    ...
    if (rt_ret != RT_ERROR_NONE) {
      REPORT_CALL_ERROR("E19999", "call rtLabelCreateV2 failed, ret:%d, index:%u,",
                        static_cast<int32_t>(rt_ret), i);
      GELOGE(RT_FAILED, "[Call][RtLabelCreate] failed. rt_ret = %d, index = %u", static_cast<int32_t>(rt_ret), i);
      return RT_FAILED;
    }
...
void RunContextUtil::DestroyRtModelResources() noexcept {
  ...
  for (size_t i = 0; i < stream_list_.size(); i++) {
    ...
    if (rt_ret != RT_ERROR_NONE) {
      GELOGW("Destroy stream failed. rt_ret = %d, index = %zu.", static_cast<int32_t>(rt_ret), i);
    }
  }
  stream_list_.clear();
  ...
  for (size_t i = 0; i < event_list_.size(); i++) {
    ...
    if (rt_ret != RT_ERROR_NONE) {
      GELOGW("Destroy event failed. rt_ret = %d, index = %zu.", static_cast<int32_t>(rt_ret), i);
    }
  }
  event_list_.clear();
  ...
  for (size_t i = 0; i < label_list_.size(); ++i) {
    ...
    if (rt_ret != RT_ERROR_NONE) {
      GELOGW("Destroy label failed. rt_ret = %d, index = %zu.", static_cast<int32_t>(rt_ret), i);
    }
  }
  label_list_.clear();
  ...
  if (rt_model_ != nullptr) {
    ...
    if (rt_ret != RT_ERROR_NONE) {
      GELOGW("Destroy rt model failed. rt_ret = %d.", static_cast<int32_t>(rt_ret));
    }
    rt_model_ = nullptr;
  }
}
