...
Status TransposeTransDataPass::CheckOneInAndOneOutDataAnchor(const NodePtr &node) const {
...
bool TransposeTransDataPass::TransDataCheckAccuracySupported(const NodePtr &node) const {
