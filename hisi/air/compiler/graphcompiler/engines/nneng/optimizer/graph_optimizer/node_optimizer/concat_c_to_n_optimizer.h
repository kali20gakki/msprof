...
#ifndef AIR_COMPILER_GRAPH_COMPILER_ENGINES_NNENG_OPTIMIZER_GRAPH_OPTIMIZER_NODE_OPTIMIZER_CONCAT_C_TO_N_OPTIMIZER_H_
#define AIR_COMPILER_GRAPH_COMPILER_ENGINES_NNENG_OPTIMIZER_GRAPH_OPTIMIZER_NODE_OPTIMIZER_CONCAT_C_TO_N_OPTIMIZER_H_
...
class ConcatCToNOptimizer {
 ...
 private:
  ...
  bool CheckPreNodeValid(const ge::NodePtr &node, const string &node_name) const;
  ...
  ConcatOptimizer checker_helper;
};
}  // namespace fe
#endif  // AIR_COMPILER_GRAPH_COMPILER_ENGINES_NNENG_OPTIMIZER_GRAPH_OPTIMIZER_NODE_OPTIMIZER_CONCAT_C_TO_N_OPTIMIZER_H_
