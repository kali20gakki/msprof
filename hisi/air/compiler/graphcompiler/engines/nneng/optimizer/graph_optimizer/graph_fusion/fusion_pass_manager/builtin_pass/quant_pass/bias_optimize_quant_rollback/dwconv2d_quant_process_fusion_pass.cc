 ...
 */
Status DWConv2DQuantProcessFusionPass::SetPadNodeDataType(const ge::NodePtr &pad_node) const {
...
Status DWConv2DQuantProcessFusionPass::SetDataTypeOfNodes(const ge::NodePtr &cube_node) {
...
ge::NodePtr DWConv2DQuantProcessFusionPass::GetCubeNodeInputNode(const ge::NodePtr &cube_node) const {
...
Status DWConv2DQuantProcessFusionPass::GetCoValue(ge::NodePtr &cube_node, int64_t &co) {
