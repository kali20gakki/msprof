...
#ifndef AIR_COMPILER_ENGINES_NNENG_OPTIMIZER_GRAPH_OPTIMIZER_OP_JUDGE_FORMAT_AND_DTYPE_STRATEGY_DTYPE_STRATEGY_OP_DTYPE_SELECTION_STRATEGY_FORCE_BF16_H_
#define AIR_COMPILER_ENGINES_NNENG_OPTIMIZER_GRAPH_OPTIMIZER_OP_JUDGE_FORMAT_AND_DTYPE_STRATEGY_DTYPE_STRATEGY_OP_DTYPE_SELECTION_STRATEGY_FORCE_BF16_H_
...
class OpDtypeSelectionStrategyForceBf16 : public OpDtypeSeletionStrategyBase {
 public:
  explicit OpDtypeSelectionStrategyForceBf16(FormatDtypeQuerierPtr format_dtype_querier_ptr,
                                             OpDtypeRiseMatcherPtr op_dtype_rise_matcher_ptr);

  ~OpDtypeSelectionStrategyForceBf16() override;
