...
Status NPUProcessNodeEngine::OptimizeGraph(const std::vector<GeTensor> &inputs, ComputeGraphPtr &compute_graph) {
  if (impl_ != nullptr) {
...
Status NPUProcessNodeEngine::BuildGraph(ComputeGraphPtr &compute_graph, PneModelPtr &model) {
  if (impl_ != nullptr) {
