...
REGISTER_OP_CREATOR(SqueezeV2, GeDeletedOp);
REGISTER_OP_CREATOR(UnsqueezeV2, GeDeletedOp);
REGISTER_OP_CREATOR(SqueezeV3, GeDeletedOp);
REGISTER_OP_CREATOR(UnsqueezeV3, GeDeletedOp);
...
REGISTER_OP_CREATOR(FlattenV2, GeDeletedOp);
}  // namespace ge_local
}  // namespace ge
