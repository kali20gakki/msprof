...
class UTEST_FE_TBE_SGT_JSON_PARSER: public testing::Test
{
 protected:
  void SetUp() {}
  void TearDown() {}
...
TEST_F(UTEST_FE_TBE_SGT_JSON_PARSER, case_json_auto_thread_mix_aic_aiv)
{
...
TEST_F(UTEST_FE_TBE_SGT_JSON_PARSER, case_ParseTvm_1_failed) { 
  OpDescPtr op_desc_ptr = make_shared<ge::OpDesc>("Sigmoid", "sigmoid");
  ComputeGraphPtr graph = std::make_shared<ComputeGraph>("test");
  NodePtr node = graph->AddNode(op_desc_ptr);
  TbeSgtJsonFileParse json_file_parse(*node);
...
TEST_F(UTEST_FE_TBE_SGT_JSON_PARSER, case_ParseTvm_0_success) { 
  OpDescPtr op_desc_ptr = make_shared<ge::OpDesc>("Sigmoid", "sigmoid");
  ComputeGraphPtr graph = std::make_shared<ComputeGraph>("test");
  NodePtr node = graph->AddNode(op_desc_ptr);
  TbeSgtJsonFileParse json_file_parse(*node);
...
TEST_F(UTEST_FE_TBE_SGT_JSON_PARSER, case_GetWorkspaceAtomicFlagAndOutputIndexFlag) { 
  OpDescPtr op_desc_ptr = make_shared<ge::OpDesc>("Sigmoid", "sigmoid");
  ComputeGraphPtr graph = std::make_shared<ComputeGraph>("test");
  NodePtr node = graph->AddNode(op_desc_ptr);
  TbeSgtJsonFileParse json_file_parse(*node);
...
TEST_F(UTEST_FE_TBE_SGT_JSON_PARSER, case_PackageTvmJsonInfo) { 
  OpDescPtr op_desc_ptr = make_shared<ge::OpDesc>("Sigmoid", "sigmoid");
...
TEST_F(UTEST_FE_TBE_SGT_JSON_PARSER, case_parse_tvm_faield) { 
  OpDescPtr op_desc_ptr = make_shared<ge::OpDesc>("Sigmoid", "sigmoid");
  ComputeGraphPtr graph = std::make_shared<ComputeGraph>("test");
  NodePtr node = graph->AddNode(op_desc_ptr);
  TbeSgtJsonFileParse json_file_parse(*node);
...
TEST_F(UTEST_FE_TBE_SGT_JSON_PARSER, case_json_kbhit_format_error_failed1)
{
...
TEST_F(UTEST_FE_TBE_SGT_JSON_PARSER, case_Parse_magic_success) {
  OpDescPtr op_desc_ptr = make_shared<ge::OpDesc>("Sigmoid", "sigmoid");
  ComputeGraphPtr graph = std::make_shared<ComputeGraph>("test");
  NodePtr node = graph->AddNode(op_desc_ptr);
  TbeSgtJsonFileParse json_file_parse(*node);
...
TEST_F(UTEST_FE_TBE_SGT_JSON_PARSER, case_parse_kbhit_failed) {
  OpDescPtr op_desc_ptr = make_shared<ge::OpDesc>("Sigmoid", "sigmoid");
  ComputeGraphPtr graph = std::make_shared<ComputeGraph>("test");
  NodePtr node = graph->AddNode(op_desc_ptr);
  TbeSgtJsonFileParse json_file_parse(*node);
