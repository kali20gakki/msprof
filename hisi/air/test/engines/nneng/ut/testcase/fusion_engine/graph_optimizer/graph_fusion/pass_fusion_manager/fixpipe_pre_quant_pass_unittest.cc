...
class fixpipe_pre_quant_pass_ut : public testing::Test {
 public:
 protected:
  void SetUp() {}
  void TearDown() {}
...
TEST_F(fixpipe_pre_quant_pass_ut, ReadConfig01) {
...
TEST_F(fixpipe_pre_quant_pass_ut, Graph01) {
  FixPipePreQuantPass m_testpass;
  bool ret = m_testpass.ReadConfig("Ascend320");
...
TEST_F(fixpipe_pre_quant_pass_ut, Graph02) {
  FixPipePreQuantPass m_testpass;
  bool ret = m_testpass.ReadConfig("Ascend320");
  ge::ComputeGraphPtr graph = std::make_shared<ge::ComputeGraph>(GRAPH_NAME);
...
TEST_F(fixpipe_pre_quant_pass_ut, Graph03) {
  FixPipePreQuantPass m_testpass;
  bool ret = m_testpass.ReadConfig("Ascend320");
  ge::ComputeGraphPtr graph = std::make_shared<ge::ComputeGraph>(GRAPH_NAME);
...
TEST_F(fixpipe_pre_quant_pass_ut, Graph04) {
  FixPipePreQuantPass m_testpass;
  bool ret = m_testpass.ReadConfig("Ascend320");
  ge::ComputeGraphPtr graph = std::make_shared<ge::ComputeGraph>(GRAPH_NAME);
...
TEST_F(fixpipe_pre_quant_pass_ut, Graph05) {
  FixPipePreQuantPass m_testpass;
  bool ret = m_testpass.ReadConfig("Ascend320");
  ge::ComputeGraphPtr graph = std::make_shared<ge::ComputeGraph>(GRAPH_NAME);
...
TEST_F(fixpipe_pre_quant_pass_ut, Graph06) {
  FixPipePreQuantPass m_testpass;
  bool ret = m_testpass.ReadConfig("Ascend320");
  ge::ComputeGraphPtr graph = std::make_shared<ge::ComputeGraph>(GRAPH_NAME);
...
TEST_F(fixpipe_pre_quant_pass_ut, Graph07) {
  FixPipePreQuantPass m_testpass;
  bool ret = m_testpass.ReadConfig("Ascend320");
  ge::ComputeGraphPtr graph = std::make_shared<ge::ComputeGraph>(GRAPH_NAME);
...
TEST_F(fixpipe_pre_quant_pass_ut, Graph08) {
  FixPipePreQuantPass m_testpass;
  bool ret = m_testpass.ReadConfig("Ascend320");
  ge::ComputeGraphPtr graph = std::make_shared<ge::ComputeGraph>(GRAPH_NAME);
...
TEST_F(fixpipe_pre_quant_pass_ut, Graph09) {
  FixPipePreQuantPass m_testpass;
  bool ret = m_testpass.ReadConfig("Ascend320");
  ge::ComputeGraphPtr graph = std::make_shared<ge::ComputeGraph>(GRAPH_NAME);
