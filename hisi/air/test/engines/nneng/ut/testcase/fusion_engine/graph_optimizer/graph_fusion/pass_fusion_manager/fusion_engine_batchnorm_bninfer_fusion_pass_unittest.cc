...
TEST_F(UTEST_fusion_engine_batchnorm_bninfer_fusion_pass, bn_relu_success) {
...
//      CreateBnGraph("BatchNorm");
//
//  Status status1 = BatchNormBnInferFusionPass().Run(*graph1);
//
//  EXPECT_EQ(fe::SUCCESS, status1);
}
