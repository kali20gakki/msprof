...
namespace fe {
  ...
  bool CheckTbeSupportedStub(te::TbeOpInfo &info, te::CheckSupportedResult &is_support,
      string &reason) {
...
*  结果： SUCCESS
*/
TEST_F(UTEST_omg_optimizer_fusion_matmul_biasadd_pass, matmul_biasadd_fusion_success)
{
...
TEST_F(UTEST_omg_optimizer_fusion_matmul_biasadd_pass, matmul_biasadd_fusion_faild)
{
    // GetContext().type = TENSORFLOW;
...
TEST_F(UTEST_omg_optimizer_fusion_matmul_biasadd_pass, matmul_add_fusion_success)
{
    // GetContext().type = TENSORFLOW;
