...
class GraphConstructor {
 ...
 private:
  ...
  /* Set the dtype and format for each node in graph_ */
//  Status Judge(shared_ptr<fe::FEOpsKernelInfoStore>& fe_ops_kernel_info_store_ptr,
//               OpStoreAdapterManagerPtr& op_store_adapter_manager_ptr,
//               const string& impl_type = "tbe-builtin");
