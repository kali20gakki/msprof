...
LOCAL_FE_ST_CPP_FILES := $(foreach st_path,$(LOCAL_PATH), $(shell find "$(st_path)" -type f))
LOCAL_FE_ST_CPP_FILES := $(LOCAL_FE_ST_CPP_FILES:$(LOCAL_PATH)/./%=$(LOCAL_PATH)%)
FE_ST_FILES  := $(filter $(LOCAL_CPP_FILES_SUFFIX),$(LOCAL_FE_ST_CPP_FILES))
FE_ST_FILES  := $(FE_ST_FILES:$(LOCAL_PATH)/%=%)
...
LOCAL_INC_COV_BLACKLIST := $(LOCAL_PATH)/fe_st_inc_cov_blacklist
