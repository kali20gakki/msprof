...
class fixpipe_pass_st : public testing::Test {
 public:
 protected:
  void SetUp() {}
  void TearDown() {}
...
TEST_F(fixpipe_pass_st, ReadConfig01) {
...
TEST_F(fixpipe_pass_st, IsCubeOpType01) {
  FixPipePass m_testpass;
...
TEST_F(fixpipe_pass_st, JudgeCachePass01) {
  FixPipePass m_testpass;
  ge::ComputeGraphPtr graph = std::make_shared<ge::ComputeGraph>(GRAPH_NAME);
  bool ret = m_testpass.ReadConfig("Ascend320");
...
TEST_F(fixpipe_pass_st, JudgeCachePass02) {
  FixPipePass m_testpass;
  ge::ComputeGraphPtr graph = std::make_shared<ge::ComputeGraph>(GRAPH_NAME);  
  bool ret = m_testpass.ReadConfig("Ascend320");
...
TEST_F(fixpipe_pass_st, PreCachePass01) {
  FixPipePass m_testpass;
  bool ret = m_testpass.ReadConfig("Ascend320");
  ge::ComputeGraphPtr graph = std::make_shared<ge::ComputeGraph>(GRAPH_NAME);
...
TEST_F(fixpipe_pass_st, PreCachePass02) {
  FixPipePass m_testpass;
  bool ret = m_testpass.ReadConfig("Ascend320");
  ge::ComputeGraphPtr graph = std::make_shared<ge::ComputeGraph>(GRAPH_NAME);
...
TEST_F(fixpipe_pass_st, PreMatchAcorrdingToPass01) {
  FixPipePass m_testpass;
  bool ret = m_testpass.ReadConfig("Ascend320");
  ge::ComputeGraphPtr graph = std::make_shared<ge::ComputeGraph>(GRAPH_NAME);
  auto node = CreateQuantNode(graph, "testnode");
...
TEST_F(fixpipe_pass_st, PreMatchAcorrdingToPass02) {
  FixPipePass m_testpass;
  bool ret = m_testpass.ReadConfig("Ascend320");
  ge::ComputeGraphPtr graph = std::make_shared<ge::ComputeGraph>(GRAPH_NAME);
  auto node = CreateQuantNode(graph, "testnode");
...
TEST_F(fixpipe_pass_st, NeedToCutPass01) {
  FixPipePass m_testpass;
  bool ret = m_testpass.ReadConfig("Ascend320");
  ge::ComputeGraphPtr graph = std::make_shared<ge::ComputeGraph>(GRAPH_NAME);
  auto node = CreateQuantNode(graph, "testnode");
...
TEST_F(fixpipe_pass_st, NeedToCutPass02) {
  FixPipePass m_testpass;
  bool ret = m_testpass.ReadConfig("Ascend320");
  ge::ComputeGraphPtr graph = std::make_shared<ge::ComputeGraph>(GRAPH_NAME);
  auto node = CreateQuantNode(graph, "testnode");
...
TEST_F(fixpipe_pass_st, IsInWhitelist01) {
  FixPipePass m_testpass;
  bool ret = m_testpass.ReadConfig("Ascend320");
  ge::ComputeGraphPtr graph = std::make_shared<ge::ComputeGraph>(GRAPH_NAME);
  auto node = CreateQuantNode(graph, "testnode");
...
TEST_F(fixpipe_pass_st, IsInWhitelist02) {
  FixPipePass m_testpass;
  bool ret = m_testpass.ReadConfig("Ascend320");
  ge::ComputeGraphPtr graph = std::make_shared<ge::ComputeGraph>(GRAPH_NAME);
  auto node = CreateQuantNode(graph, "testnode");
...
TEST_F(fixpipe_pass_st, JudgeIsMatch01) {
  FixPipePass m_testpass;
  bool ret = m_testpass.ReadConfig("Ascend320");
  ge::ComputeGraphPtr graph = std::make_shared<ge::ComputeGraph>(GRAPH_NAME);
  auto node = CreateQuantNode(graph, "testnode");
...
TEST_F(fixpipe_pass_st, JudgeIsMatch02) {
  FixPipePass m_testpass;
  bool ret = m_testpass.ReadConfig("Ascend320");
  ge::ComputeGraphPtr graph = std::make_shared<ge::ComputeGraph>(GRAPH_NAME);
  auto node = CreateQuantNode(graph, "testnode");
...
TEST_F(fixpipe_pass_st, AddInput04) {
  FixPipePass m_testpass;
...
TEST_F(fixpipe_pass_st, AddInput05) {
  FixPipePass m_testpass;
...
TEST_F(fixpipe_pass_st, AddInput06) {
  FixPipePass m_testpass;
...
TEST_F(fixpipe_pass_st, AddInput07) {
  FixPipePass m_testpass;
...
TEST_F(fixpipe_pass_st, AddInput08) {
  FixPipePass m_testpass;
...
TEST_F(fixpipe_pass_st, AddInput09) {
  FixPipePass m_testpass;
...
TEST_F(fixpipe_pass_st, AddInput10) {
  FixPipePass m_testpass;
...
TEST_F(fixpipe_pass_st, AddInput11) {
  FixPipePass m_testpass;
...
TEST_F(fixpipe_pass_st, AddInput12) {
  FixPipePass m_testpass;
...
TEST_F(fixpipe_pass_st, AddInput13) {
  FixPipePass m_testpass;
...
TEST_F(fixpipe_pass_st, AddInput14) {
  FixPipePass m_testpass;
...
TEST_F(fixpipe_pass_st, AddInput15) {
  FixPipePass m_testpass;
...
TEST_F(fixpipe_pass_st, AddInput16) {
  FixPipePass m_testpass;
...
TEST_F(fixpipe_pass_st, AddInput17) {
  FixPipePass m_testpass;
...
TEST_F(fixpipe_pass_st, AddInput18) {
  FixPipePass m_testpass;
...
TEST_F(fixpipe_pass_st, AddInput19) {
  FixPipePass m_testpass;
...
TEST_F(fixpipe_pass_st, AddInput20) {
  FixPipePass m_testpass;
...
TEST_F(fixpipe_pass_st, AddInput21) {
  FixPipePass m_testpass;
...
TEST_F(fixpipe_pass_st, AddInput22) {
  FixPipePass m_testpass;
...
TEST_F(fixpipe_pass_st, AddInput23) {
  FixPipePass m_testpass;
...
TEST_F(fixpipe_pass_st, AddInput24) {
  FixPipePass m_testpass;
...
TEST_F(fixpipe_pass_st, AddInput25) {
  FixPipePass m_testpass;
...
TEST_F(fixpipe_pass_st, AddInput26) {
  FixPipePass m_testpass;
...
TEST_F(fixpipe_pass_st, AddInput27) {
  FixPipePass m_testpass;
...
TEST_F(fixpipe_pass_st, AddInput28) {
  FixPipePass m_testpass;
...
TEST_F(fixpipe_pass_st, AddInput29) {
  FixPipePass m_testpass;
...
TEST_F(fixpipe_pass_st, AddInput30) {
  FixPipePass m_testpass;
...
TEST_F(fixpipe_pass_st, AddInput31) {
  FixPipePass m_testpass;
...
TEST_F(fixpipe_pass_st, AddInput32) {
  FixPipePass m_testpass;
...
TEST_F(fixpipe_pass_st, AddInput33) {
  FixPipePass m_testpass;
...
TEST_F(fixpipe_pass_st, AddInput34) {
  FixPipePass m_testpass;
...
TEST_F(fixpipe_pass_st, AddInput35) {
  FixPipePass m_testpass;
...
TEST_F(fixpipe_pass_st, AddInput42) {
  FixPipePass m_testpass;
...
TEST_F(fixpipe_pass_st, AddInput43) {
  FixPipePass m_testpass;
...
TEST_F(fixpipe_pass_st, AddInput44) {
  FixPipePass m_testpass;
...
TEST_F(fixpipe_pass_st, AddInput45) {
  FixPipePass m_testpass;
...
TEST_F(fixpipe_pass_st, AddInput46) {
  FixPipePass m_testpass;
...
TEST_F(fixpipe_pass_st, AddInput47) {
  FixPipePass m_testpass;
...
TEST_F(fixpipe_pass_st, AddInput48) {
  FixPipePass m_testpass;
...
TEST_F(fixpipe_pass_st, AddInput49) {
  FixPipePass m_testpass;
...
TEST_F(fixpipe_pass_st, AddInput50) {
  FixPipePass m_testpass;
...
TEST_F(fixpipe_pass_st, AddInput51) {
  FixPipePass m_testpass;
...
TEST_F(fixpipe_pass_st, AddInput52) {
  FixPipePass m_testpass;
...
TEST_F(fixpipe_pass_st, AddInput53) {
  FixPipePass m_testpass;
...
TEST_F(fixpipe_pass_st, AddInput54) {
  FixPipePass m_testpass;
...
TEST_F(fixpipe_pass_st, GenraterPass01) {
  FixPipePass m_testpass;
...
TEST_F(fixpipe_pass_st, GenraterPass04) {
  FixPipePass m_testpass;
...
TEST_F(fixpipe_pass_st, GenraterPass05) {
  FixPipePass m_testpass;
...
TEST_F(fixpipe_pass_st, GenraterPass36) {
  FixPipePass m_testpass;
...
TEST_F(fixpipe_pass_st, GenraterPass37) {
  FixPipePass m_testpass;
...
TEST_F(fixpipe_pass_st, GenraterPass38) {
  FixPipePass m_testpass;
...
TEST_F(fixpipe_pass_st, GenraterPass39) {
  FixPipePass m_testpass;
...
TEST_F(fixpipe_pass_st, GenraterPass40) {
  FixPipePass m_testpass;
...
TEST_F(fixpipe_pass_st, GenraterPass41) {
  FixPipePass m_testpass;
...
TEST_F(fixpipe_pass_st, GenraterPass55) {
  FixPipePass m_testpass;
...
TEST_F(fixpipe_pass_st, GenraterPass56) {
  FixPipePass m_testpass;
  ge::ComputeGraphPtr graph = std::make_shared<ge::ComputeGraph>(GRAPH_NAME);
...
TEST_F(fixpipe_pass_st, GenraterPass57) {
  FixPipePass m_testpass;
  ge::ComputeGraphPtr graph = std::make_shared<ge::ComputeGraph>(GRAPH_NAME);
...
TEST_F(fixpipe_pass_st, GenraterPass57_1) {
  FixPipePass m_testpass;
  ge::ComputeGraphPtr graph = std::make_shared<ge::ComputeGraph>(GRAPH_NAME);
...
TEST_F(fixpipe_pass_st, GenraterPass58) {
  FixPipePass m_testpass;
  ge::ComputeGraphPtr graph = std::make_shared<ge::ComputeGraph>(GRAPH_NAME);
...
TEST_F(fixpipe_pass_st, GenraterPass59) {
  FixPipePass m_testpass;
  ge::ComputeGraphPtr graph = std::make_shared<ge::ComputeGraph>(GRAPH_NAME);
...
TEST_F(fixpipe_pass_st, GenraterPass59_1) {
 FixPipePass m_testpass;
...
TEST_F(fixpipe_pass_st, GenraterPass60) {
 FixPipePass m_testpass;
...
TEST_F(fixpipe_pass_st, GenraterPass61) {
 FixPipePass m_testpass;
