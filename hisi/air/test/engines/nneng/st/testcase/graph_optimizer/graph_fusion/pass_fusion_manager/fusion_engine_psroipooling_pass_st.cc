...
bool CheckTbeSupportedStubPSROI(te::TbeOpInfo &info, te::CheckSupportedResult &is_support, string &reason) {
  is_support = te::FULLY_SUPPORTED;
  return true;
}

class STEST_fusion_engine_psroipooling_pass : public testing::Test
{
public:
...
TEST_F(STEST_fusion_engine_psroipooling_pass, swapci_fusion_success)
{
...
TEST_F(STEST_fusion_engine_psroipooling_pass, swapci_fusion_no_output_dim)
{
...
TEST_F(STEST_fusion_engine_psroipooling_pass, swapci_fusion_no_group_size)
{
...
TEST_F(STEST_fusion_engine_psroipooling_pass, swapco_fusion_success)
{
...
TEST_F(STEST_fusion_engine_psroipooling_pass, swapci_fusion_conv_input_not_two)
{
...
TEST_F(STEST_fusion_engine_psroipooling_pass, swapci_fusion_psroi_input_not_two)
{
  ComputeGraphPtr graph = CreateTestGraph("SwapCo", 21, -1);
  PSROIPoolingFusionPass pass;
  pass.group_size_=-1;
