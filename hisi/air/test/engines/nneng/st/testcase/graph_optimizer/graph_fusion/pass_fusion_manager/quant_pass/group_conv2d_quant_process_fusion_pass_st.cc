...
class STEST_GROUP_CONV2D_QUANT_PROCESS_FUSION : public testing::Test {
 protected:
  void SetUp() {}
  void TearDown(){}
};
 ...
 *   conv2d
 */
TEST_F(STEST_GROUP_CONV2D_QUANT_PROCESS_FUSION, GET_CO_VALUE_SUCCESS) {
  ...
  OpDescPtr op_desc_c = std::make_shared<OpDesc>("conv2d", "Conv2D");
  ...
  GroupConv2DQuantProcessFusionPass pass1;
  ge::NodePtr cube_node = graph->FindNode("conv2d");
  int64_t co;
