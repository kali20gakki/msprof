...
class STEST_fusion_engine_tf_merge_conv2dbpi_fusion_pass : public testing::Test {
protected:
  void SetUp() {}
  void TearDown() {}
...
TEST_F(STEST_fusion_engine_tf_merge_conv2dbpi_fusion_pass, pattern_success) {
...
TEST_F(STEST_fusion_engine_tf_merge_conv2dbpi_fusion_pass, merge_sub_pattern_normal_success) {
...
TEST_F(STEST_fusion_engine_tf_merge_conv2dbpi_fusion_pass, merge_sub_pattern_normal_success_v200) {
...
TEST_F(STEST_fusion_engine_tf_merge_conv2dbpi_fusion_pass, merge_sub_pattern_sharesub_success) {
...
TEST_F(STEST_fusion_engine_tf_merge_conv2dbpi_fusion_pass, merge_sub_pattern_nobias_success) {
...
TEST_F(STEST_fusion_engine_tf_merge_conv2dbpi_fusion_pass, merge_sub_pattern_sharesub_nobias_success) {
...
TEST_F(STEST_fusion_engine_tf_merge_conv2dbpi_fusion_pass, set_const_value_to_attr_test) {
