...
class STEST_fusion_engine_tf_quant_fusion_pass : public testing::Test {
protected:
  void SetUp() {}
  void TearDown() {}
...
TEST_F(STEST_fusion_engine_tf_quant_fusion_pass, pattern_success) {
...
TEST_F(STEST_fusion_engine_tf_quant_fusion_pass, merge_sub_pattern_success) {

  ge::ComputeGraphPtr graph = CreateMergeSubSucessGraph();
...
TEST_F(STEST_fusion_engine_tf_quant_fusion_pass, merge_sub_pattern_success2) {
...
TEST_F(STEST_fusion_engine_tf_quant_fusion_pass, merge_sub_pattern_onnx_batchmatmulv2_success) {
  std::vector<ge::NodePtr> node_list;
