...
class STEST_concat_c_to_n_optimize : public testing::Test {
 public:
...
TEST_F(STEST_concat_c_to_n_optimize, checker_fail_for_unknownshape) {
...
TEST_F(STEST_concat_c_to_n_optimize, MeetAlignmentConditionFromNCHWTo5HD_suc) {
...
TEST_F(STEST_concat_c_to_n_optimize, MeetAlignmentConditionFromNCHWTo5HD_suc1) {
  OpDescPtr op_desc = std::make_shared<OpDesc>("add", "Add");
...
TEST_F(STEST_concat_c_to_n_optimize, CheckPreNodeValid_suc) {
...
TEST_F(STEST_concat_c_to_n_optimize, concat_c_to_n_no_task_001) {
  ge::ComputeGraphPtr graph = std::make_shared<ComputeGraph>(GRAPH_NAME);
  InitGraph3(graph);
  ConcatCToNOptimizer concat_c_to_optimize;
  concat_c_to_optimize.SetFusionVirtualOp(*graph);
...
TEST_F(STEST_concat_c_to_n_optimize, concat_c_to_n_no_task_002) {
  ge::ComputeGraphPtr graph = std::make_shared<ComputeGraph>(GRAPH_NAME);
  InitGraph4(graph);
  ConcatCToNOptimizer concat_c_to_optimize;
  concat_c_to_optimize.SetFusionVirtualOp(*graph);
...
TEST_F(STEST_concat_c_to_n_optimize, concat_c_to_n_no_task_003) {
  ge::ComputeGraphPtr graph = std::make_shared<ComputeGraph>(GRAPH_NAME);
  InitGraph5(graph);
  ConcatCToNOptimizer concat_c_to_optimize;
  concat_c_to_optimize.SetFusionVirtualOp(*graph);
...
TEST_F(STEST_concat_c_to_n_optimize, concat_c_to_n_no_task_004) {
  ge::ComputeGraphPtr graph = std::make_shared<ComputeGraph>(GRAPH_NAME);
  InitGraph6(graph);
  ConcatCToNOptimizer concat_c_to_optimize;
  concat_c_to_optimize.SetFusionVirtualOp(*graph);
...
TEST_F(STEST_concat_c_to_n_optimize, concat_c_to_n_no_task_005) {
  ge::ComputeGraphPtr graph = std::make_shared<ComputeGraph>(GRAPH_NAME);
  InitGraph7(graph);
  ConcatCToNOptimizer concat_c_to_optimize;
  concat_c_to_optimize.SetFusionVirtualOp(*graph);
...
TEST_F(STEST_concat_c_to_n_optimize, concat_c_to_n_no_task_006) {
  ge::ComputeGraphPtr graph = std::make_shared<ComputeGraph>(GRAPH_NAME);
  InitGraph8(graph);
  ConcatCToNOptimizer concat_c_to_optimize;
  concat_c_to_optimize.SetFusionVirtualOp(*graph);
...
TEST_F(STEST_concat_c_to_n_optimize, concat_c_to_n_no_task_007) {
  ge::ComputeGraphPtr graph = std::make_shared<ComputeGraph>(GRAPH_NAME);
  InitGraph9(graph);
  ConcatCToNOptimizer concat_c_to_optimize;
  concat_c_to_optimize.SetFusionVirtualOp(*graph);
...
TEST_F(STEST_concat_c_to_n_optimize, concat_c_to_n_no_task_008) {
  ge::ComputeGraphPtr graph = std::make_shared<ComputeGraph>(GRAPH_NAME);
  InitGraph10(graph);
  ConcatCToNOptimizer concat_c_to_optimize;
  concat_c_to_optimize.SetFusionVirtualOp(*graph);
...
TEST_F(STEST_concat_c_to_n_optimize, concat_c_to_n_no_task_009) {
  ge::ComputeGraphPtr graph = std::make_shared<ComputeGraph>(GRAPH_NAME);
  InitGraph11(graph);
  ConcatCToNOptimizer concat_c_to_optimize;
  concat_c_to_optimize.SetFusionVirtualOp(*graph);
