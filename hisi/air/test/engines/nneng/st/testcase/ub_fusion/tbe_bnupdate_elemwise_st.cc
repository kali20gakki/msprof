...
class UB_FUSION_ST_BNUPDATE_ELEMWISE : public testing::Test {
public:
...
TEST_F(UB_FUSION_ST_BNUPDATE_ELEMWISE, bn_update_relu_fusion_pass) {
...
TEST_F(UB_FUSION_ST_BNUPDATE_ELEMWISE, bn_update_add_relu_fusion_pass) {
...
TEST_F(UB_FUSION_ST_BNUPDATE_ELEMWISE, bn_update_add_relu_fusion_pass_oneout) {
...
TEST_F(UB_FUSION_ST_BNUPDATE_ELEMWISE, bn_update_add_relu_fusion_pass_multiout) {
...
TEST_F(UB_FUSION_ST_BNUPDATE_ELEMWISE, bn_update_multi_relu_fusion_pass) {
