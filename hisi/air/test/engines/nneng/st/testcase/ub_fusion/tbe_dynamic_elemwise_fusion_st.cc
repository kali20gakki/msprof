...
using namespace ge;
namespace fe_st {
class TbeDynamicElemwiseFusionSTest : public testing::Test {
 public:
...
TEST_F(TbeDynamicElemwiseFusionSTest, broad_cast_elemwise_1) {
  ...
  cerr << "TbeDynamicElemwiseFusionSTest UB fusion after match" << endl;
  for (auto &node: graph_out->GetDirectNode()) {
    uint32_t scope_id = 0;
  ...
  graph_out->Dump();
  cerr << endl;
  cerr << "TbeDynamicElemwiseFusionSTest UB fusion result" << endl;
  for (auto &node: graph_out->GetDirectNode()) {
    uint32_t scope_id = 0;
    cerr << "name: " << node->GetName() << ", type:" << node->GetOpDesc()->GetType();
    if (AttrUtils::GetInt(node->GetOpDesc(), SCOPE_ID_ATTR, scope_id)) {
...
TEST_F(TbeDynamicElemwiseFusionSTest, broad_cast_elemwise_2) {
  ComputeGraphPtr graph_out = std::make_shared<ComputeGraph>("test");
...
TEST_F(TbeDynamicElemwiseFusionSTest, broad_cast_elemwise_3) {
  ComputeGraphPtr graph_out = std::make_shared<ComputeGraph>("test");
...
TEST_F(TbeDynamicElemwiseFusionSTest, reduce_elemwise_1) {
  ComputeGraphPtr graph_out = std::make_shared<ComputeGraph>("test");
...
TEST_F(TbeDynamicElemwiseFusionSTest, reduce_elemwise_2) {
  ComputeGraphPtr graph_out = std::make_shared<ComputeGraph>("test");
...
TEST_F(TbeDynamicElemwiseFusionSTest, reduce_elemwise_3) {
  ComputeGraphPtr graph_out = std::make_shared<ComputeGraph>("test");
...
TEST_F(TbeDynamicElemwiseFusionSTest, reduce_elemwise_4) {
  ComputeGraphPtr graph_out = std::make_shared<ComputeGraph>("test");
...
TEST_F(TbeDynamicElemwiseFusionSTest, reduce_elemwise_5) {
  ComputeGraphPtr graph_out = std::make_shared<ComputeGraph>("test");
...
TEST_F(TbeDynamicElemwiseFusionSTest, reduce_elemwise_6) {
  ComputeGraphPtr graph_out = std::make_shared<ComputeGraph>("test");
...
TEST_F(TbeDynamicElemwiseFusionSTest, check_dynamic_impl_1) {
  ComputeGraphPtr graph_out = std::make_shared<ComputeGraph>("test");
...
TEST_F(TbeDynamicElemwiseFusionSTest, check_dynamic_impl_2) {
  ComputeGraphPtr graph_out = std::make_shared<ComputeGraph>("test");
...
TEST_F(TbeDynamicElemwiseFusionSTest, test_infinite_loop_1) {
  ComputeGraphPtr graph_out = std::make_shared<ComputeGraph>("test");
...
TEST_F(TbeDynamicElemwiseFusionSTest, test_infinite_loop_2) {
  ComputeGraphPtr graph_out = std::make_shared<ComputeGraph>("test");
...
TEST_F(TbeDynamicElemwiseFusionSTest, test_infinite_loop_3) {
  ComputeGraphPtr graph_out = std::make_shared<ComputeGraph>("test");
...
TEST_F(TbeDynamicElemwiseFusionSTest, test_infinite_loop_4) {
  ComputeGraphPtr graph_out = std::make_shared<ComputeGraph>("test");
  BuildGraphInfiniteLoop2(graph_out);
  graph_out->TopologicalSorting();
...
TEST_F(TbeDynamicElemwiseFusionSTest, test_infinite_loop_5) {
  ComputeGraphPtr graph_out = std::make_shared<ComputeGraph>("test");
  BuildGraphInfiniteLoop3(graph_out);
  graph_out->TopologicalSorting();
...
TEST_F(TbeDynamicElemwiseFusionSTest, test_infinite_loop_6) {
  ComputeGraphPtr graph_out = std::make_shared<ComputeGraph>("test");
...
TEST_F(TbeDynamicElemwiseFusionSTest, test_infinite_loop_7) {
  ComputeGraphPtr graph_out = std::make_shared<ComputeGraph>("test");
  BuildGraphInfiniteLoop5(graph_out);
  graph_out->TopologicalSorting();
...
TEST_F(TbeDynamicElemwiseFusionSTest, test_infinite_loop_8) {
  ComputeGraphPtr graph_out = std::make_shared<ComputeGraph>("test");
  BuildGraphInfiniteLoop5(graph_out);
  graph_out->TopologicalSorting();
...
TEST_F(TbeDynamicElemwiseFusionSTest, test_infinite_loop_9) {
  ComputeGraphPtr graph_out = std::make_shared<ComputeGraph>("test");
  BuildGraphInfiniteLoop5(graph_out);
  graph_out->TopologicalSorting();
