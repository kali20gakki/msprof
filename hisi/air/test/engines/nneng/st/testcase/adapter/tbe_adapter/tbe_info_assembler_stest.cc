...
TEST_F(STEST_TbeInfoAssembler, Test_JudgeShapeToSetFlag){
...
TEST_F(STEST_TbeInfoAssembler, UpdateOpPrecisionMode_1){
...
TEST_F(STEST_TbeInfoAssembler, UpdateOpPrecisionMode_2){
  map<std::string, std::string> options;
...
TEST_F(STEST_TbeInfoAssembler, UpdateOpPrecisionMode_3){
  map<std::string, std::string> options;
  options.emplace(ge::OP_SELECT_IMPL_MODE, "high_performance");
  std::string op_precision_mode_str;
  TbeInfoAssembler tbe_info_assembler;
...
TEST_F(STEST_TbeInfoAssembler, UpdateOpPrecisionMode_4){
  map<std::string, std::string> options;
...
TEST_F(STEST_TbeInfoAssembler, UpdateOpPrecisionMode_5){
  map<std::string, std::string> options;
