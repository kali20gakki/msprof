...
TEST_F(STestFusionConfigParser, fusion_switch_01) {
  Configuration::Instance(fe::AI_CORE_NAME).content_map_["fusion.config.built-in.file"] =
          "plugin/opskernel/fe_config/fusion_config.json";
  Configuration::Instance(fe::AI_CORE_NAME).lib_path_ =
          "./air/test/engines/nneng/st/testcase/fusion_config_manager/builtin_config/";
  Configuration::Instance(fe::AI_CORE_NAME).custom_fusion_config_file_ =
          "./air/test/engines/nneng/st/testcase/fusion_config_manager/custom_config/fusion_config.json";
...
TEST_F(STestFusionConfigParser, fusion_switch_02) {
  Configuration::Instance(fe::AI_CORE_NAME).content_map_["fusion.config.built-in.file"] =
          "plugin/opskernel/fe_config/fusion_config.json";
  Configuration::Instance(fe::AI_CORE_NAME).lib_path_ =
          "./air/test/engines/nneng/st/testcase/fusion_config_manager/builtin_config1/";
  Configuration::Instance(fe::AI_CORE_NAME).custom_fusion_config_file_ =
          "./air/test/engines/nneng/st/testcase/fusion_config_manager/custom_config/fusion_config1.json";
  Configuration::Instance(fe::AI_CORE_NAME).InitLicenseFusion(allStr);
  FusionConfigParserPtr fusionConfigParserPtr = std::make_shared<FusionConfigParser>(fe::AI_CORE_NAME);
  fusionConfigParserPtr->ParseFusionConfigFile();
  bool ret = fusionConfigParserPtr->GetFusionSwitchByName("PassThroughFusionPass", "GraphFusion");
...
TEST_F(STestFusionConfigParser, fusion_switch_03) {
  Configuration::Instance(fe::AI_CORE_NAME).content_map_["fusion.config.built-in.file"] =
          "plugin/opskernel/fe_config/fusion_config.json";
  Configuration::Instance(fe::AI_CORE_NAME).lib_path_ =
          "./air/test/engines/nneng/st/testcase/fusion_config_manager/builtin_config2/";
  Configuration::Instance(fe::AI_CORE_NAME).custom_fusion_config_file_ =
          "./air/test/engines/nneng/st/testcase/fusion_config_manager/custom_config/fusion_config2.json";
  Configuration::Instance(fe::AI_CORE_NAME).InitLicenseFusion(allStr);
  FusionConfigParserPtr fusionConfigParserPtr = std::make_shared<FusionConfigParser>(fe::AI_CORE_NAME);
  fusionConfigParserPtr->ParseFusionConfigFile();
  bool ret = fusionConfigParserPtr->GetFusionSwitchByName("PassThroughFusionPass", "GraphFusion");
...
TEST_F(STestFusionConfigParser, modify_fusion_priority_map_test) {
  Configuration::Instance(fe::AI_CORE_NAME).InitLicenseFusion(allStr);
  Configuration::Instance(fe::AI_CORE_NAME).lib_path_ =
