...
if (AIR_PB_PKG)
    set(REQ_URL "${AIR_PB_PKG}/libs/securec/v1.1.10.tar.gz")
    set(MD5 "")
else()
...
ExternalProject_Add(c_sec_build
                    ...
                    #SOURCE_DIR ${AIR_CODE_DIR}/../libc_sec
                    PATCH_COMMAND patch -p1 < ${AIR_CODE_DIR}/third_party/patch/securec/0001-add-securec-cmake-script.patch
                    TLS_VERIFY OFF
...
ExternalProject_Get_Property(c_sec_build SOURCE_DIR)
ExternalProject_Get_Property(c_sec_build BINARY_DIR)
