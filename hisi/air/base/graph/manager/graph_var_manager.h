...
namespace ge {
constexpr size_t kGraphMemoryManagerMallocMaxSize = 27917287424U; // 26UL * 1024UL * 1024UL * 1024UL;
constexpr size_t kMemoryVarManagerMallocSize = 5368709120U; // 5UL * 1024UL * 1024UL * 1024UL;
constexpr size_t kMemoryVarLogicBase = 34359738368U; // 32UL * 1024UL * 1024UL * 1024UL;
constexpr size_t kMemoryHostFeatureMapLogicBase = 68719476736U; // 64UL * 1024UL * 1024UL * 1024UL;
constexpr size_t kUseMaxMemorySize = kGraphMemoryManagerMallocMaxSize + kMemoryVarManagerMallocSize;
constexpr size_t kGraphMemoryBuffer = 34359738368U; // 32UL * 1024UL * 1024UL * 1024UL;
constexpr size_t kMaxMemorySize = 274877906944U; // 256UL * 1024UL * 1024UL * 1024UL;
...
class VarManager {
 public:
  ...
  Status MallocVarMemory(const size_t memory_size = kMemoryVarManagerMallocSize,
 ...
 private:
  ...
  Status ParseMemoryMallocSize(const std::string &memory_size, size_t &target_size) const;
};
