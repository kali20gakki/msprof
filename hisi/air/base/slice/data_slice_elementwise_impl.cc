...
static AxisInferRegister registerElementWise(ge::AxisType::ELEMENTWISE,
  [] (void)->DataSliceInferBase* {return new (std::nothrow) DataSliceElementwiseImpl();});

// Elementwise
Status DataSliceElementwiseImpl::InferAxisSlice(ge::Operator &op, const AxisTypeInfo &slice_info,
    const DataSliceType &out_data_slice, DataSliceType &in_data_slice)
{
  ...
  // one input and one output eltwise data slice
