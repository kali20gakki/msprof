...
class Executor {
 public:
  ...
  ///
  virtual Status LoadGraph(const FlowModelPtr &ge_root_model, const GraphNodePtr &graph_node) = 0;
  ...
  /// @return Status result of function
  ///
  virtual Status UnloadGraph(const FlowModelPtr &ge_root_model, const uint32_t graph_id) = 0;
