...
TEST_F(UtestFormatTransferDhwncFractalZ3DTranspose, dhwcn_invalid_data_type_string) {
  ...
  TransArgs args{data, FORMAT_DHWNC, FORMAT_FRACTAL_Z_3D_TRANSPOSE, {1, 4, 4, 1, 16, 16}, {4, 4, 3, 1}, DT_STRING};
  TransResult result;
...
TEST_F(UtestFormatTransferDhwncFractalZ3DTranspose, dhwcn_data_type_uint8_invalid_shape) {
  ...
  TransArgs args{data, FORMAT_DHWNC, FORMAT_FRACTAL_Z_3D_TRANSPOSE, {1, 4, 4, 1, 16, 16}, {4, 4, 3, 1}, DT_UINT8};
  TransResult result;
...
TEST_F(UtestFormatTransferDhwncFractalZ3DTranspose, dhwcn_data_type_uint8_dst_invalid_shape) {
  ...
  TransArgs args{data, FORMAT_DHWNC, FORMAT_FRACTAL_Z_3D_TRANSPOSE, {1, 4, 4, 16, 16}, {4, 4, 3, 1}, DT_UINT8};
  TransResult result;
...
TEST_F(UtestFormatTransferDhwncFractalZ3DTranspose, dhwcn_data_type_uint8_success) {
  ...
  TransArgs args{data, FORMAT_DHWNC, FORMAT_FRACTAL_Z_3D_TRANSPOSE, {1, 4, 4, 16, 16}, {16, 1, 16, 32}, DT_UINT8};
  TransResult result;
