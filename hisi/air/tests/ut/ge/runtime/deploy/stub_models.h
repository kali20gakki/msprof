...
class SubModels {
 public:
  ...
  ///    |      |
  ///  data1  data2
  static ComputeGraphPtr BuildGraphWithoutNeedForBindingQueues();

  static GeRootModelPtr BuildRootModel(ComputeGraphPtr root_graph, bool pipeline_partitioned = true);
