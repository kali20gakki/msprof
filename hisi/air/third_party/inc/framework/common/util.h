...
/// @return false fail
///
GE_FUNC_VISIBILITY bool ReadProtoFromBinaryFile(const char *file, google::protobuf::Message *proto);
...
/// @return false fail
///
GE_FUNC_VISIBILITY bool ReadProtoFromArray(const void *data, int size, google::protobuf::Message *proto);
