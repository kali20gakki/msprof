...
class AICoreConfig(MetaConfig):
    DATA = {
        ...
        'metrics': [
            ...
            ('mac_ratio_extra', '1.0*(r49+r4a)/task_cyc'),
            ('mac_time_extra', '(1.0*(r49+r4a)*1000000/(freq))/block_num*((block_num+core_num-1)/core_num)'),
        ...
        'formula': [
            ...
            ('mac_ratio_extra', '1.0*(SUM(r4a)+Sum(r49))/SUM(task_cyc)'),
