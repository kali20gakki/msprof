...
class AICoreConfig(MetaConfig):
    DATA = {
        ...
        'metrics': [
            ('total_time(ms)', '(task_cyc*1000/(freq))/block_num*((block_num+core_num-1)/core_num)'),
            ('total_cycles', 'task_cyc'),
            ('mac_fp16_ratio', '1.0*r49/task_cyc'),
            ('mac_int8_ratio', '1.0*r4a/task_cyc'),
            ('vec_ratio', '1.0*r8/task_cyc'),
            ('vec_time', '(1.0*r8*1000/(freq))/block_num*((block_num+core_num-1)/core_num)'),
            ('mac_ratio', '1.0*ra/task_cyc'),
            ('mac_time', '(1.0*ra*1000/(freq))/block_num*((block_num+core_num-1)/core_num)'),
            ('scalar_ratio', '1.0*r9/task_cyc'),
            ('scalar_time', '(1.0*r9*1000/(freq))/block_num*((block_num+core_num-1)/core_num)'),
            ('fixpipe_ratio', '1.0*r303/task_cyc'),
            ('fixpipe_time', '(1.0*r303*1000/(freq))/block_num*((block_num+core_num-1)/core_num)'),
            ...
            ('mte1_time', '(1.0*rb*1000/(freq))/block_num*((block_num+core_num-1)/core_num)'),
            ('mte2_ratio', '1.0*rc/task_cyc'),
            ('mte2_time', '(1.0*rc*1000/(freq))/block_num*((block_num+core_num-1)/core_num)'),
            ('mte3_ratio', '1.0*rd/task_cyc'),
            ('mte3_time', '(1.0*rd*1000/(freq))/block_num*((block_num+core_num-1)/core_num)'),
        ...
        'formula': [
            ('total_time(ms)', 'SUM((task_cyc*1000/(freq))/block_num*((block_num+core_num-1)/core_num))'),
            ('total_cycles', 'task_cyc'),
