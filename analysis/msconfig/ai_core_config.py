...
class AICoreConfig(MetaConfig):
    DATA = {
        ...
        'metrics': [
            ...
            ('cube_ratio', '1.0*(r49+r4a)/task_cyc'),
            ('cube_time', '(1.0*(r49+r4a)*1000000/(freq))/block_num*((block_num+core_num-1)/core_num)'),
            ...
            ('mte1_active_ratio', '1.0*r302/task_cyc'),
            ('mte1_active_time', '(1.0*r302*1000000/(freq))/block_num*((block_num+core_num-1)/core_num)'),
        ...
        'formula': [
            ...
            ('cube_ratio', '1.0*(SUM(r4a)+Sum(r49))/SUM(task_cyc)'),
            ...
            ('mte1_active_ratio', '1.0*SUM(r302)/SUM(task_cyc)'),
