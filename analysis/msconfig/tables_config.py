...
class TablesConfig(MetaConfig):
    DATA = {
        ...
        'KfcCommTurnMap': [
            ...
            ('wait_notify_start_time', 'INT,null'),
            ('kfc_alg_exe_start_time', 'INT,null'),
            ('send_task_start_time', 'INT,null'),
            ('wait_active_start_time', 'INT,null'),
            ('active_start_time', 'INT,null'),
            ('wait_exe_end_start_time', 'INT,null'),
        ...
        'KfcTaskMap': [
            ...
            ('index_id', 'INTEGER,null'),
            ('op_name', 'TEXT,null'),
            ('op_timestamp', 'NUMERIC,null'),
            ('op_duration', 'NUMERIC,null'),
            ('iteration', 'INTEGER,null'),
            ('hccl_name', 'TEXT,null'),
            ('group_name', 'TEXT,null'),
            ('plane_id', 'INTEGER,null'),
