...
# coding=utf-8
"""
function: this script used to operate NIC
...
class NicModel(BaseModel, ABC):
    ...
    def create_nicreceivesend_data(self: any, func_id: int) -> list:
        ...
        :return: None
        """
        self.cur.row_factory = ClassRowType.class_row(NicDto)
        ...
        nic_obj_list = DBManager.fetch_all_data(self.cur, _sql, (self.device_id, func_id))
