...
class HostDiskUsage(HostProfDataBase):
    ...
    def get_disk_usage_data(self: any) -> dict:
        ...
        for disk_item in disk_info_list:
            time_mem = {
                "start": InfoConfReader().trans_into_local_time(disk_item[0], NumberConstant.NANO_SECOND),
                "end": InfoConfReader().trans_into_local_time(disk_item[1], NumberConstant.NANO_SECOND),
                "usage": disk_item[5]
            }
