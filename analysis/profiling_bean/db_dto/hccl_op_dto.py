...
class HcclOpDto:
    ...
    @hccl_name.setter
    def hccl_name(self: any, value: str) -> None:
    ...
    @plane_id.setter
    def plane_id(self: any, value: int) -> None:
    ...
    @timestamp.setter
    def timestamp(self: any, value: float) -> None:
    ...
    @duration.setter
    def duration(self: any, value: float) -> None:
        self._duration = value

    @property
    def bandwidth(self: any) -> float:
        return self._bandwidth

    @bandwidth.setter
    def bandwidth(self: any, value: float) -> None:
    ...
    @stream_id.setter
    def stream_id(self: any, value: int) -> None:
    ...
    @task_id.setter
    def task_id(self: any, value: int) -> None:
        self._task_id = value
    ...
    @task_type.setter
    def task_type(self: any, value: str) -> None:
    ...
    @notify_id.setter
    def notify_id(self: any, value: int) -> None:
    ...
    @stage.setter
    def stage(self: any, value: int) -> None:
        self._stage = value
    ...
    @step.setter
    def step(self: any, value: int) -> None:
        self._step = value
    ...
    @dst_rank.setter
    def dst_rank(self: any, value: int) -> None:
    ...
    @src_rank.setter
    def src_rank(self: any, value: int) -> None:
    ...
    def transport_type(self: any, value: str) -> None:
        self._transport_type = value

    @property
    def size(self: any) -> float:
        return self._size

    @size.setter
    def size(self: any, value: float) -> None:
        self._size = value
