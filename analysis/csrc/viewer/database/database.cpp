...
namespace {
    const std::vector<TableColumn> ApiEventData = {
    ...
    const std::vector<TableColumn> HostTask = {
    ...
    const std::vector<TableColumn> TaskInfo = {
        {"model_id", SQL_INTEGER_TYPE},
    ...
    const std::vector<TableColumn> StepInfo = {
        {"model_id", SQL_INTEGER_TYPE},
        {"thread_id", SQL_INTEGER_TYPE},
        {"timestamp", SQL_NUMERIC_TYPE},
    ...
    const std::vector<TableColumn> GeHashInfo = {
        {"hash_key", SQL_TEXT_TYPE},
        {"hash_value", SQL_TEXT_TYPE}
    };

    const std::vector<TableColumn> TypeHashInfo = {
        {"hash_key", SQL_TEXT_TYPE},
        {"hash_value", SQL_TEXT_TYPE},
        {"level", SQL_TEXT_TYPE}
    };

    const std::vector<TableColumn> HCCLTask = {
        {"model_id", SQL_INTEGER_TYPE},
        {"index_id", SQL_INTEGER_TYPE},
        {"name", SQL_TEXT_TYPE},
    ...
    const std::vector<TableColumn> HCCLOP = {
        {"device_id", SQL_INTEGER_TYPE},
        {"model_id", SQL_INTEGER_TYPE},
        {"index_id", SQL_INTEGER_TYPE},
        {"thread_id", SQL_INTEGER_TYPE},
    ...
    const std::vector<TableColumn> HostTaskFlip = {
        {"stream_id", SQL_INTEGER_TYPE},
        {"timestamp", SQL_NUMERIC_TYPE},
        {"task_id", SQL_INTEGER_TYPE},
    ...
    const std::vector<TableColumn> AscendTask = {
        {"model_id", SQL_INTEGER_TYPE},
        {"index_id", SQL_INTEGER_TYPE},
        {"stream_id", SQL_INTEGER_TYPE},
        {"task_id", SQL_INTEGER_TYPE},
    ...
    const std::vector<TableColumn> HCCLSingleDevice = {
        {"model_id", SQL_INTEGER_TYPE},
        {"index_id", SQL_INTEGER_TYPE},
        {"op_name", SQL_TEXT_TYPE},
