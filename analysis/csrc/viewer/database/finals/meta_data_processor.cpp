...
const std::unordered_map<std::string, std::string> META_DATA = {
    {MSG_STR(SCHEMA_VERSION), SCHEMA_VERSION},
    {MSG_STR(SCHEMA_VERSION_MAJOR), SCHEMA_VERSION_MAJOR},
    {MSG_STR(SCHEMA_VERSION_MINOR), SCHEMA_VERSION_MINOR},
    {MSG_STR(SCHEMA_VERSION_MICRO), SCHEMA_VERSION_MICRO}
};
}
