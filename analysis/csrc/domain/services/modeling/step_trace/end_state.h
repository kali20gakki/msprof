...
#ifndef ANALYSIS_DOMAIN_SERVICES_MODELING_STEP_TRACE_END_STATE_H
#define ANALYSIS_DOMAIN_SERVICES_MODELING_STEP_TRACE_END_STATE_H
...
#endif // ANALYSIS_DOMAIN_SERVICES_MODELING_STEP_TRACE_END_STATE_H
