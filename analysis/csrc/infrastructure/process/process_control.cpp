 ...
 */
bool ProcessControl::RunProcesses(ProcessCollection& chipRelatedProcess, DataInventory& dataInventory,
...
void ProcessControl::RunPreparedProcess(ProcessCollection &preparedProcess, std::vector<ProcessStatistcs> &stat,
...
bool ProcessControl::GetStatistician(std::vector<ProcessStatistcs>&& statistics, bool& dfxStop)
{
...
void ProcessControl::ReleaseNoLongerUsedData(const ProcessCollection& chipRelatedProcess, DataInventory& dataInventory,
                                             size_t levelIndex)
{
...
ProcessCollection ProcessControl::TakeAwayPreparedProcess(ProcessCollection& chipRelatedProcess) const
{
