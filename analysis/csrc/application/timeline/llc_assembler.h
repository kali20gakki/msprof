...
#ifndef ANALYSIS_APPLICATION_LLC_ASSEMBLER_H
#define ANALYSIS_APPLICATION_LLC_ASSEMBLER_H

#include "analysis/csrc/application/timeline/json_assembler.h"

namespace Analysis {
namespace Application {
class LLcAssembler : public JsonAssembler {
public:
    LLcAssembler();
private:
...
#endif // ANALYSIS_APPLICATION_LLC_ASSEMBLER_H
