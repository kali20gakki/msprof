...
#ifndef ANALYSIS_APPLICATION_DDR_ASSEMBLER_H
#define ANALYSIS_APPLICATION_DDR_ASSEMBLER_H

#include "analysis/csrc/application/timeline/json_assembler.h"

namespace Analysis {
namespace Application {
class DDRAssembler : public JsonAssembler {
public:
    DDRAssembler();
private:
...
#endif // ANALYSIS_APPLICATION_DDR_ASSEMBLER_H
