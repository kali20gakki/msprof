...
class StructFmt:
    ...
    MSPROFTX_EX_FMT = 'HHLLLQQQQ128s'
    MSPROFTX_EX_FMT_SIZE = struct.calcsize(BYTE_ORDER_CHAR + MSPROFTX_EX_FMT)
    ...
    NANO_MODEL_EXEOM_SIZE = 256
    NANO_MODEL_EXEOM_FMT = "HHIIIQQQ"
    NANO_STARS_PROFILE_PMU_COUNT = 10
    NANO_STARS_PROFILE_FMT = "BBHHHIIIHBB" + "I" * NANO_STARS_PROFILE_PMU_COUNT

    # mc2
    MC2_COMM_INFO_FMT = "HHIIIQQ56I"
    MC2_COMM_INFO_SIZE = struct.calcsize(BYTE_ORDER_CHAR + MC2_COMM_INFO_FMT)
    KFC_HCCL_INFO_FMT = "HHIII4Q6IQ2Id3Q6IH3H26I"
