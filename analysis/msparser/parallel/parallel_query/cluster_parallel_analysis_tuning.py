...
class ClusterParallelAnalysisTuning:
    ...
    def _storage_parallel_analysis_result(self: any) -> None:
        if not self._tuning_suggestion:
            return
        ...
        if not os.path.exists(query_path):
            try:
                ...
                os.error(MsProfCommonConstant.COMMON_FILE_NAME,
        ...
        try:
            with os.fdopen(os.open(output_file_path, Constant.WRITE_FLAGS,
                ...
                json.dump(self._tuning_suggestion, file)
        except (OSError, SystemError, ValueError, TypeError, RuntimeError) as err:
            os.error(MsProfCommonConstant.COMMON_FILE_NAME, err)
        else:
