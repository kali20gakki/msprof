...
**电压数据分析<a name="zh-cn_topic_0000001751419248_section51959345010"></a>**
...
**图 1**  CANN层数据<a name="zh-cn_topic_0000001656264690_fig1951420493165"></a>  
...
**图 1**  memory\_record\_\*.csv<a name="zh-cn_topic_0000001704519578_fig18726153033320"></a>  
...
**图 1**  片上内存1<a name="zh-cn_topic_0000001704519574_fig766519153238"></a>  
![](figures/片上内存1.png "片上内存1")

**图 2**  片上内存2<a name="zh-cn_topic_0000001704519574_fig128671226172320"></a>  
![](figures/片上内存2.png "片上内存2")

上图展示了片上内存的读写速率，单位为MB/s。

**ddr\_\*.csv文件说明<a name="zh-cn_topic_0000001704519574_section11791341554"></a>**

ddr\_\*.csv文件内容格式示例如下：

**图 3**  ddr\_\*.csv<a name="zh-cn_topic_0000001704519574_fig4397103862317"></a>  
...
**hbm\_\*.csv文件说明<a name="zh-cn_topic_0000001704519574_section0146822185620"></a>**

hbm\_\*.csv文件内容格式示例如下：

**图 4**  hbm\_\*.csv<a name="zh-cn_topic_0000001704519574_fig13282164482314"></a>  
