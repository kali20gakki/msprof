...
#### 1. msprof_*.json（timeline数据总表）<a name="ZH-CN_TOPIC_0000002477303238"></a>
...
#### 2. op\_summary（算子详细信息）<a name="ZH-CN_TOPIC_0000002477303242"></a>
...
#### 3. msproftx数据说明<a name="ZH-CN_TOPIC_0000002509383185"></a>
...
#### 4. task\_time（任务调度信息）<a name="ZH-CN_TOPIC_0000002509503207"></a>
...
#### 5. api\_statistic（API耗时统计信息）<a name="ZH-CN_TOPIC_0000002477303240"></a>
...
#### 6. step\_trace（迭代轨迹信息）<a name="ZH-CN_TOPIC_0000002477463224"></a>
...
#### 7. communication\_statistic（集合通信算子统计信息）<a name="ZH-CN_TOPIC_0000002509503209"></a>
...
#### 8. op\_statistic（算子调用次数及耗时）<a name="ZH-CN_TOPIC_0000002509383189"></a>
...
#### 9. npu\_mem（NPU内存占用）<a name="ZH-CN_TOPIC_0000002509383193"></a>
...
#### 10. npu\_module\_mem（NPU组件内存占用）<a name="ZH-CN_TOPIC_0000002509503215"></a>
...
#### 11. memory\_record（CANN算子的内存占用记录）<a name="ZH-CN_TOPIC_0000002477303250"></a>
...
#### 12. operator\_memory（CANN算子的内存占用明细）<a name="ZH-CN_TOPIC_0000002477463232"></a>
...
#### 1. dp（数据增强信息）<a name="ZH-CN_TOPIC_0000002509383187"></a>
...
#### 2. l2\_cache（L2 Cache命中率）<a name="ZH-CN_TOPIC_0000002477303246"></a>
...
#### 3. fusion\_op（算子融合信息）<a name="ZH-CN_TOPIC_0000002477463230"></a>
...
#### 4. static\_op\_mem（静态图算子内存）<a name="ZH-CN_TOPIC_0000002509383197"></a>
...
#### 5. sys\_mem（系统内存数据）<a name="ZH-CN_TOPIC_0000002509503219"></a>
...
#### 6. process\_mem（进程内存占用数据）<a name="ZH-CN_TOPIC_0000002477303252"></a>
...
#### 7. process\_cpu\_usage（进程CPU占用率）<a name="ZH-CN_TOPIC_0000002509383199"></a>
...
#### 8. 片上内存读写速率<a name="ZH-CN_TOPIC_0000002509503221"></a>
...
#### 9. hccs（集合通信带宽）<a name="ZH-CN_TOPIC_0000002477463236"></a>
...
#### 10. nic（每个时间节点网络信息）<a name="ZH-CN_TOPIC_0000002509383201"></a>
...
#### 11. roce（RoCE通信接口带宽）<a name="ZH-CN_TOPIC_0000002509503223"></a>
...
#### 12. pcie（PCIe带宽）<a name="ZH-CN_TOPIC_0000002477303256"></a>
...
#### 13. biu\_group/aic\_core\_group/aiv\_core\_group（AI Core和AI Vector的带宽和延时）<a name="ZH-CN_TOPIC_0000002477463238"></a>
...
#### 14. Acc PMU（加速器带宽及并发信息）<a name="ZH-CN_TOPIC_0000002509383203"></a>
...
#### 15. Stars Soc Info（SoC传输带宽信息）<a name="ZH-CN_TOPIC_0000002509503225"></a>
...
#### 16. Stars Chip Trans（片间传输带宽信息）<a name="ZH-CN_TOPIC_0000002477303258"></a>
...
#### 17. llc\_read\_write（三级缓存读写速率）<a name="ZH-CN_TOPIC_0000002477463240"></a>
...
#### 18. dvpp（DVPP信息）<a name="ZH-CN_TOPIC_0000002477463244"></a>
...
#### 19. ai\_cpu\_top\_function（AI CPU热点函数）<a name="ZH-CN_TOPIC_0000002509383209"></a>
...
#### 20. ai\_cpu\_pmu\_events（AI CPU PMU事件）<a name="ZH-CN_TOPIC_0000002509503231"></a>
...
#### 21. ctrl\_cpu\_top\_function（Ctrl CPU热点函数）<a name="ZH-CN_TOPIC_0000002477303264"></a>
...
#### 22. ctrl\_cpu\_pmu\_events（Ctrl CPU PMU事件）<a name="ZH-CN_TOPIC_0000002477463246"></a>
...
#### 23. ts\_cpu\_top\_function（TS CPU热点函数）<a name="ZH-CN_TOPIC_0000002509383211"></a>
...
#### 24. ts\_cpu\_pmu\_events（TS CPU PMU事件）<a name="ZH-CN_TOPIC_0000002509503233"></a>
...
#### 25. host\_cpu\_usage（Host侧CPU利用率）<a name="ZH-CN_TOPIC_0000002477463248"></a>
...
#### 26. host\_mem\_usage（Host侧内存利用率）<a name="ZH-CN_TOPIC_0000002509383213"></a>
...
#### 27. host\_disk\_usage（Host侧磁盘I/O利用率）<a name="ZH-CN_TOPIC_0000002509503235"></a>
...
#### 28. host\_network\_usage（Host侧网络I/O利用率）<a name="ZH-CN_TOPIC_0000002477303268"></a>
...
#### 29. os\_runtime\_statistic（Host侧syscall和pthreadcall）<a name="ZH-CN_TOPIC_0000002477463250"></a>
...
#### 30. cpu\_usage（Host侧系统CPU利用率）<a name="ZH-CN_TOPIC_0000002509383215"></a>
...
#### 31. process\_cpu\_usage（Host侧进程CPU利用率）<a name="ZH-CN_TOPIC_0000002509503237"></a>
...
#### 32. sys\_mem（Host侧系统内存利用率）<a name="ZH-CN_TOPIC_0000002477303270"></a>
...
#### 33. process\_mem（Host侧进程内存利用率）<a name="ZH-CN_TOPIC_0000002477463252"></a>
...
#### 34. ai\_core\_utilization（AI Core指令占比）<a name="ZH-CN_TOPIC_0000002509503211"></a>
...
#### 35. ai\_vector\_core\_utilization（AI Vector Core指令占比）<a name="ZH-CN_TOPIC_0000002477463228"></a>
...
#### 36. aicpu（AI CPU算子详细耗时）<a name="ZH-CN_TOPIC_0000002509383191"></a>
...
#### 37. aicpu\_mi（数据准备的队列）<a name="ZH-CN_TOPIC_0000002509503213"></a>
...
#### 38. cpu\_usage（AI CPU、Ctrl CPU利用率）<a name="ZH-CN_TOPIC_0000002477463234"></a>
